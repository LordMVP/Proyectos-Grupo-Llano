...
class GenerarFinanciacionModel extends AuditoriaServices {
     ...
     */
    public function consultarFacturasPorSuscripcionDocumentoModel($idSuscripcion, $idDocumento, $idTipoDocumento, $idconceptodescarte=NULL) {
        $complemento = '';
        ...
        if (!empty($idconceptodescarte)) {
            $complementoconceptos = "and fac.fac_ideregistro not in (SELECT DISTINCT
                ...
                AND facc.uni_tipdocument = :idTipoDocumento and dfaci.uni_concepto in  (".$idconceptodescarte.")   and dfaci.dfac_sdoreal>0  ) " ;
        }
        ...
        $sql = "SELECT DISTINCT
                ...
                AND fac.uni_tipdocument = :idTipoDocumento  $complemento $complementoconceptos

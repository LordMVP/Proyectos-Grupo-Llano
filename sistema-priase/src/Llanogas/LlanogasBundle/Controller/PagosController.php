...
class PagosController extends Controller {
    ...
    public function getSuscripcionesPagoAction() {
        try {
            ...
            $idSuscripcionAseoCarteraNoHomologada = empty($request->get('idsuscripcionaseocarteranohomologada')) ? 0 : $request->get('idsuscripcionaseocarteranohomologada') ;
            $recaudosDelegado = new RecaudosDelegado($this, $sesion);
            $suscripciones = $recaudosDelegado->getSuscripcionesPagos($idSuscriptor,$idSuscripcionAseoCarteraNoHomologada);

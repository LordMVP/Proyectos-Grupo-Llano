...
use Llanogas\LlanogasBundle\ProcesosMasivos\Procesos\ProcesoImportarFactura;
 ...
 * @author hrey
 */
class EjecutaProcesoImportarFacturas {
    ...
    public function run() {
        $ProcesoImportarFactura = new ProcesoImportarFactura($this->parametros);
        try {
...
$procesoFacturacion = new EjecutaProcesoImportarFacturas($parametros);

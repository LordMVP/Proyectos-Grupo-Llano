 ...
 * están relacionadas con las financiaciones.
 *
 * @author rsagudelo
 */
class FinanciacionesModel extends AuditoriaServices {
     ...
     */
    public function getFacturasConSaldo($suscripciones) {
        return $this->genericoModel->getFacturasConSaldo($suscripciones);
    }
     ...
     */
    public function getSuscripcionesPagos($idSuscriptor) {
        ...
        $sql = "select
                ...
                where dsus.dsus_estado='A' and sus.sus_ideregistro=:idsuscriptor and fac.fac_estado = 'A' and fac.fac_sdoreal>0 ";
        return $this->executeQuery($sql, $parametros);
    }

...
//put your code here
    public function __construct(&$conexion = null ,$idempresa = null ) {
    ...
    public function consultaPrincipal($page = 1, $count = 10, $extra = null) {
        ...
        $condicion = count($condiciones)==0?"WHERE fin.emp_ideregistro= :idempresa and  fin.fin_estado = 'A'":" WHERE fin.emp_ideregistro= :idempresa and  fin.fin_estado = 'A' AND ".  implode(" AND ", $condiciones);        
        $sql = "SELECT 

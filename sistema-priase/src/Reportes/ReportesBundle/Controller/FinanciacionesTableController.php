...
class FinanciacionesTableController extends Controller {
    ...
    public function getInfo(\Symfony\Component\HttpFoundation\Request $request) {
        ...
        $model = new \Reportes\ReportesBundle\Models\FinanciacionesTableModel($base->conexion, $base->idEmpresa);
    ...
    public function getColumns() {
        $base = $this->get("reportes.base");
        $model = new \Reportes\ReportesBundle\Models\FinanciacionesTableModel($base->conexion);

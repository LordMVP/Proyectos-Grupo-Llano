...
/* LlanogasLlanogasBundle:Cartera:FinanciacionCRUD.html.twig */
class __TwigTemplate_ea2e93f23c231a97ebcafaffdd84d89b8c42dddf456002d57c7b78b75ce06ea3 extends Twig_Template
{
...
";
    ...
    {
        echo "Cartera: Administrar Financiación - ";
    ...
    <div id=\"divFormulario\">
        <fieldset id=\"divCabecera\">
            ...
            <div class=\"campo\">
                <label for=\"txtSuscriptor\">Id suscriptor:</label>
                <input type=\"text\" id=\"txtSuscriptor\" disabled=\"disabled\" />
            </div>
        ...
        <fieldset id=\"divFinanciacion\">
            ...
            <div class=\"campo\">
                ...
                <p id=\"pFechaActual\" style=\"display:none\"></p>
                <input type=\"text\" id=\"txtFecha\" disabled=\"disabled\" />
            </div>

            <div class=\"campo\">
                <label for=\"txtBanco\">Banco:</label>
                <input type=\"text\" id=\"txtBanco\" disabled=\"disabled\" />
            </div>
            ...
            <div class=\"campo\">
                ...
                <input type=\"text\" id=\"txtNombreSolicitante\" disabled=\"disabled\" />
            </div>

\t    <div class=\"campo\">
                <label for=\"txtParentescoSolicitante\">Parentesco Solicitante:</label>
                <input type=\"text\" id=\"txtParentescoSolicitante\" disabled=\"disabled\" />
            </div>
            ...
            <div class=\"campo\">
                ...
                <input type=\"text\" id=\"txtTipoDocumento\" disabled=\"disabled\" />  
            </div>
            <div class=\"campoCorto\">
                <label for=\"txtEstado\">Estado:</label>
                <input type=\"text\" id=\"txtEstado\" maxlength=\"2\" disabled=\"disabled\" />
            </div>
            <div class=\"campoCorto\">
                <label for=\"txtCapitalInicial\">Capital inicial:</label>
                <input type=\"text\" id=\"txtCapitalInicial\" maxlength=\"2\" disabled=\"disabled\" />
            </div>
            <div class=\"campoCorto\">
                <label for=\"txtSaldoCapital\">Saldo capital:</label>
                <input type=\"text\" id=\"txtSaldoCapital\" maxlength=\"2\" disabled=\"disabled\" />
            </div>
            <div class=\"campoCorto\">
                <label for=\"txtNumCuotas\">Cuotas:</label>
                <input type=\"text\" id=\"txtNumCuotas\" maxlength=\"2\"  disabled=\"disabled\"/>
            </div>

            <div class=\"campoCorto\">
                <label for=\"txtCuotasAmortizadas\">Amortizadas:</label>
                <input type=\"text\" id=\"txtCuotasAmortizadas\" maxlength=\"2\" disabled=\"disabled\" />
            </div>
            <div class=\"campoCorto\">
                <label for=\"txtNumCuotasPendientes\">Pendientes:</label>
                <input type=\"text\" id=\"txtNumCuotasPendientes\" maxlength=\"2\" disabled=\"disabled\" />
            </div>
            ...
            <div class=\"campoCorto\">
                <input type=\"button\" id=\"btnVerArchivos\" value=\"Ver adjuntos\" class=\"btnSimple\"/>
            </div>
            <div class=\"campo\" style=\"width: auto;\">
                <input type=\"button\" id=\"btnCargarAmortización\" value=\"Ver amortizaciones\" class=\"btnSimple\"/>
            </div>
\t    <div class=\"campo\" style=\"width: auto;\">
                <input type=\"button\" id=\"btnImprimirFormatos\" value=\"Imprimir Formatos\" class=\"btnSimple\"/>
            </div>
            <div class=\"campo\" style=\"width: auto;\">
                <button class=\"btnSimple\" id=\"btnAdicionarArchivos\" style=\"display: none;\" > <i class=\"fa fa-arrow-up\"   ></i> Adicionar archivos</button>
            </div>
        </fieldset>

        <table id=\"tblFacturas\" class=\"tabla\" ></table>
        <table id=\"tblAmortizacion\" class=\"tabla\" ></table>
        <fieldset id=\"divArchivos\" style=\"display: none;\">
            <legend>Adjuntos de la financiación</legend>
            <input type=\"file\" id=\"txtArchivo\" />
        </fieldset>

\t<fieldset id=\"divFormatos\" style=\"display: none;\">
            <legend>Formatos de la financiación</legend>
            <div id=\"divAdjuntosFinanciacion\">
                <div id=\"divArchivosContrato\" data-id=\"fin\">
                    ...
                    <div class=\"archivoSubido\">
                        ...
                        <strong>Formato de Financiación de Deuda</strong>
                    </div>
                </div>
            </div>
        </fieldset>        
        ...
        <div id=\"divAdjuntosFinanciacion\" style=\"display: none;\">
            ...
            <div id=\"divArchivosNew\">
                <div style=\"margin: 20px 20px\">
                    <div><input type=\"file\" id=\"txtArchivoNew\" multiple></div>
                    <button class=\"btnSimple\" id=\"btnSubirArchivos\"  > <i class=\"fa fa-upload\"></i> Adjuntar archivos de financiacion </button>
                </div>
            </div>
        </div>
    ...
    <div id=\"divInfoFinanciera\" style=\"display: none;\">
        <fieldset id=\"divJuridica\">
            <legend>Información empresarial</legend>
            <div class=\"campo\">
                <label for=\"txtActividadEmpresarial\"> Actividad Económica: </label>
                <input type=\"text\" id=\"txtActividadEmpresarial\" disabled=\"disabled\" data-reference=\"actividadeconomica\"/>
            </div>
            <div class=\"campo\">
                <label for=\"txtTipoSociedad\">Tipo de sociedad: </label>
                <input type=\"text\" id=\"txtTipoSociedad\" data-reference=\"tiposociedad\" />
            </div>
            <div class=\"campo\">
                <label for=\"\">Años Experiencia </label>
                <div class=\"campoMitad\" style=\"width: 46%\">
                    <label for=\"txtAnioExperienciaEmpresarial\">Años :</label>
                    <input type=\"text\" id=\"txtAnioExperienciaEmpresarial\" data-reference=\"aniolaborado\" maxlength=\"3\">
                </div>
            ...
            <div class=\"campo\">
                ...
                <input type=\"text\" id=\"txtDireccionEmpresarial\" disabled=\"disabled\" data-reference=\"direccion\">
            </div>

            <div class=\"campo\">
                <label for=\"txtBarrioEmpresarial\">Barrio: </label>
                <input type=\"text\" id=\"txtBarrioEmpresarial\" disabled=\"disabled\" data-reference=\"barrio\">
            </div>
            <div class=\"campo\">
                <label for=\"txtMunicipioEmpresarial\">Municipio:</label>
                <input type=\"text\" id=\"txtMunicipioEmpresarial\" disabled=\"disabled\" data-reference=\"municipio\">
            </div>
            <div class=\"campo\">
                <label for=\"txtDepartamentoEmpresarial\">Departamento: </label>
                <input type=\"text\" id=\"txtDepartamentoEmpresarial\" disabled=\"disabled\" data-reference=\"departamento\">
            </div>
            <div class=\"campo\">
                <label for=\"txtEstratoCat\">Estrato/Categoría: </label>
                <input type=\"text\" id=\"txtEstratoCat\" disabled=\"disabled\" data-reference=\"estrato\">
            </div>
            <div class=\"campo\">
                <label for=\"txtCorreoEmpresarial\">Correo electrónico: </label>
                <input type=\"text\" id=\"txtCorreoEmpresarial\" disabled=\"disabled\" data-reference=\"correo\">
            </div>
            <div class=\"campo\">
                <label for=\"txtTelefono1Empresarial\">Teléfono 1</label>
                <input type=\"text\" id=\"txtTelefono1Empresarial\" disabled=\"disabled\" data-reference=\"telefonofijo\">
            </div>
            <div class=\"campo\">
                <label for=\"txtTelefono2Empresarial\">Teléfono 2</label>
                <input type=\"text\" id=\"txtTelefono2Empresarial\" disabled=\"disabled\" data-reference=\"telefonocelular\">
            </div>
        </fieldset>
        <div id=\"divNatural\">
            <ul>
            ...
            <div id=\"divLaboral\">
                ...
                <div class=\"campo\">
                    ...
                    <input type=\"text\" id=\"txtOcupacionLaboral\" disabled=\"disabled\" data-reference=\"actividadeconomica\"/>
                </div>
                <div class=\"campo\">
                ...
                <div class=\"campo\">
                    ...
                    <input type=\"text\" id=\"txtCargoLaboral\" data-reference=\"cargolaboral\" disabled=\"disabled\"/>
                </div>
                <div class=\"campo\">
                    <label for=\"txtTelefono1Laboral\">Teléfono 1: </label>
                    <input type=\"text\" id=\"txtTelefono1Laboral\" data-reference=\"telefonofijo\" disabled=\"disabled\">
                </div>
                <div class=\"campo\">
                    <label for=\"txtTelefono2Laboral\">Teléfono 2: </label>
                    <input type=\"text\" id=\"txtTelefono2Laboral\" data-reference=\"telefonocelular\" disabled=\"disabled\">
                </div>
            </div>
            <div id=\"divFinanciera\">
                ...
                <fieldset>
                    ...
                    <div class=\"campo\">
                        <label for=\"txtNomOtroIngreso\">Otro Ingreso: </label>
                ...
                <fieldset>
                    ...
                    <div class=\"campo\">
                        <label for=\"txtGastoFamiliar\">Gastos familiares:</label>
                    ...
                    <div class=\"campo\">
                        <label for=\"txtNomOtroEgreso\">Otro egreso: </label>
                ...
                <fieldset>
                    ...
                    <div class=\"campo\">
                        ...
                        <input type=\"text\" id=\"txtEfectivo\" data-caja=\"number\" data-reference=\"efectivo\">
                    </div>
                    <div class=\"campo\">
    ...
    <div id=\"camposBuscarSuscripcion\" style=\"display:none;\" >
        ...
        <div class=\"campo\">
            <label for=\"txtFiltroFinanciacion\">Id Financiación:</label>
            <input type=\"text\" id=\"txtFiltroFinanciacion\" data-attr=\"financiacion\" />
        </div>
    ...
    <div id=\"divDetallesFactura\" style=\"display:none;\">
        <fieldset>
            ...
            <div class=\"campo\">
                ...
                <input type=\"text\" id=\"txtFechaFactura\" disabled=\"disabled\"/>
            </div>

            <div class=\"campo\">
                <label for=\"txtEstadoFactura\">Estado:</label>
                <input type=\"text\" id=\"txtEstadoFactura\" disabled=\"disabled\"/>
            </div>

            <div class=\"campo\">
                <label for=\"txtValorFactura\">Valor:</label>
                <input type=\"text\" id=\"txtValorFactura\" disabled=\"disabled\"/>
            </div>
    ...
    <div id=\"divDetalleAmortizacion\" style=\"display:none;\">
        <table id=\"tblDetalleAmortizacion\" class=\"tabla\"></table>
    </div>
    ...
    <div id=\"divSimulador\" style=\"display:none;\" >
        ...
        <div style=\"display: flex; justify-content: space-between;\">
            ...
            <div class=\"rows-4\">
                ...
                <input type=\"text\" id=\"txtNumeroCuotas\" maxlength=\"2\" placeholder=\"N�mero cuotas\"  value=\"10\" class=\"inputImpresion input-width-max\" disabled=\"disabled\"/>
            </div>
...
";
    ...
    <script type=\"text/javascript\" src=\"";
        // line 555
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/Llanogas/js/cartera/financiacion_crud/financiacion_crud.control.js"), "html", null, true);
        echo "\"></script>
    <script type=\"text/javascript\" src=\"";
        // line 556
    ...
    <script type=\"text/javascript\" src=\"";
        // line 558
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/Llanogas/js/cartera/financiacion_crud/financiacion_crud.modelo.js"), "html", null, true);
        echo "\"></script>
    <script type=\"text/javascript\" src=\"";
        // line 559
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/Llanogas/js/cartera/financiacion_crud/financiacion_crud.vista.js"), "html", null, true);
        echo "\"></script>
";
    }
    ...
    {
        return "LlanogasLlanogasBundle:Cartera:FinanciacionCRUD.html.twig";
    }
    ...
    {
        return array (  639 => 559,  635 => 558,  631 => 557,  627 => 556,  623 => 555,  619 => 554,  615 => 553,  611 => 552,  606 => 551,  603 => 550,  65 => 13,  62 => 12,  54 => 10,  49 => 8,  46 => 7,  40 => 4,  35 => 3,  32 => 2,);
    }
}

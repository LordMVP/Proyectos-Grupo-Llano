...
/* LlanogasLlanogasBundle:Recaudos:autorizar_impresiones.html.twig */
class __TwigTemplate_f2bb21e2d1744130e556d76b9e642b100e2ad1776a1bedeb838db18b7662391f extends Twig_Template
{
...
";
    ...
    {
        echo "Recaudos: Autorizar impresión por usuario - ";
    ...
    <div id=\"divPanelContenedor\">
        <fieldset id=\"fieldCabecera\">
            ...
            <h3 style=\"font-size: 14px; color: #408BC4; margin-top: 15px;\"> Información usuario </h3>
            
            <div class=\"campo\">
                <label for=\"txtDocumentoUsuario\">Documento Usuario:</label>
                <input type=\"text\" id=\"txtDocumentoUsuario\" disabled=\"disabled\"/>
            </div>
            <div class=\"campo\">
                <label for=\"txtUsuario\">Nombre Usuario:</label>
                <input type=\"text\" id=\"txtUsuario\" disabled=\"disabled\"/>
            </div>
            <div class=\"campo\">
                <label for=\"txtCantImpresiones\">Cant. Impresiones:</label>
                <input type=\"text\" id=\"txtCantImpresiones\" disabled=\"disabled\"/>
            </div>
            <table id=\"tblImpresiones\" class=\"tabla\"></table>
        </fieldset>
    ...
    <div id=\"divFormaPImprimir\" align=\"center\" style=\"display:none\">
        <table id=\"tblFormaPago\" class=\"tabla\" style=\"width: 50%;\">
...
";
    ...
    <script type=\"text/javascript\" src=\"";
        // line 162
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/Llanogas/js/recaudos/autorizacion_impresion/autorizacion_impresion.control.js"), "html", null, true);
        echo "\"></script>
    <script type=\"text/javascript\" src=\"";
        // line 163
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/Llanogas/js/recaudos/autorizacion_impresion/autorizacion_impresion.vista.js"), "html", null, true);
        echo "\"></script>
";
    }
    ...
    {
        return "LlanogasLlanogasBundle:Recaudos:autorizar_impresiones.html.twig";
    }
    ...
    {
        return array (  232 => 163,  228 => 162,  224 => 161,  219 => 160,  216 => 159,  74 => 19,  71 => 18,  63 => 16,  58 => 13,  55 => 12,  48 => 8,  43 => 6,  39 => 5,  35 => 3,  32 => 2,);
    }
}

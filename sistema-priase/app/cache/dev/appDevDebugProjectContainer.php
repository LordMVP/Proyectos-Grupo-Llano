...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'admin.reportes' => 'getAdmin_ReportesService',
            ...
            'e6cc0307ed9a17cb71408c4735142f0e_1' => 'getE6cc0307ed9a17cb71408c4735142f0e1Service',
            'e6cc0307ed9a17cb71408c4735142f0e_2' => 'getE6cc0307ed9a17cb71408c4735142f0e2Service',
            'e6cc0307ed9a17cb71408c4735142f0e_3' => 'getE6cc0307ed9a17cb71408c4735142f0e3Service',
            ...
            'reportes.base' => 'getReportes_BaseService',
            ...
            'swiftmailer.mailer.potenza' => 'getSwiftmailer_Mailer_PotenzaService',
            'swiftmailer.mailer.potenza.plugin.messagelogger' => 'getSwiftmailer_Mailer_Potenza_Plugin_MessageloggerService',
            'swiftmailer.mailer.potenza.spool' => 'getSwiftmailer_Mailer_Potenza_SpoolService',
            'swiftmailer.mailer.potenza.transport' => 'getSwiftmailer_Mailer_Potenza_TransportService',
            'swiftmailer.mailer.potenza.transport.eventdispatcher' => 'getSwiftmailer_Mailer_Potenza_Transport_EventdispatcherService',
            'swiftmailer.mailer.potenza.transport.real' => 'getSwiftmailer_Mailer_Potenza_Transport_RealService',
            'swiftmailer.mailer.prisma' => 'getSwiftmailer_Mailer_PrismaService',
            'swiftmailer.mailer.prisma.plugin.messagelogger' => 'getSwiftmailer_Mailer_Prisma_Plugin_MessageloggerService',
            'swiftmailer.mailer.prisma.spool' => 'getSwiftmailer_Mailer_Prisma_SpoolService',
            'swiftmailer.mailer.prisma.transport' => 'getSwiftmailer_Mailer_Prisma_TransportService',
            'swiftmailer.mailer.prisma.transport.eventdispatcher' => 'getSwiftmailer_Mailer_Prisma_Transport_EventdispatcherService',
            'swiftmailer.mailer.prisma.transport.real' => 'getSwiftmailer_Mailer_Prisma_Transport_RealService',
        ...
        $this->aliases = array(
            ...
            'mailer' => 'swiftmailer.mailer.potenza',
            'sensio.distribution.webconfigurator' => 'sensio_distribution.webconfigurator',
            'session.storage' => 'session.storage.php_bridge',
            'swiftmailer.mailer' => 'swiftmailer.mailer.potenza',
            'swiftmailer.plugin.messagelogger' => 'swiftmailer.mailer.potenza.plugin.messagelogger',
            'swiftmailer.spool' => 'swiftmailer.mailer.potenza.spool',
            'swiftmailer.transport' => 'swiftmailer.mailer.potenza.transport',
            'swiftmailer.transport.real' => 'swiftmailer.mailer.potenza.transport.real',
        );
    }
    ...
    /**
     * Gets the 'admin.reportes' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Reportes\ReportesBundle\JasperBridge\AdminReports A Reportes\ReportesBundle\JasperBridge\AdminReports instance.
     */
    protected function getAdmin_ReportesService()
    {
        return $this->services['admin.reportes'] = new \Reportes\ReportesBundle\JasperBridge\AdminReports($this->get('kernel'));
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/html/achagua/sistema/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/html/achagua/sistema/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/var/www/html/achagua/sistema/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/var/www/html/achagua/sistema/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '10.43.51.68', 'port' => 5432, 'dbname' => 'Tecnico', 'user' => 'postgres', 'password' => 'Admpos1650.', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_631d55d68b84f842510012c9c14bac79');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_631d55d68b84f842510012c9c14bac79');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_631d55d68b84f842510012c9c14bac79');
        ...
        $d->setProxyDir('/var/www/html/achagua/sistema/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/var/www/html/achagua/sistema/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/var/www/html/achagua/sistema/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/var/www/html/achagua/sistema/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    /**
     * Gets the 'reportes.base' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Reportes\ReportesBundle\Controller\ReporteBaseController A Reportes\ReportesBundle\Controller\ReporteBaseController instance.
     */
    protected function getReportes_BaseService()
    {
        return $this->services['reportes.base'] = new \Reportes\ReportesBundle\Controller\ReporteBaseController($this);
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/var/www/html/achagua/sistema/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/var/www/html/achagua/sistema/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/html/achagua/sistema/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/html/achagua/sistema/app');
    }
    ...
    {
        return $this->services['session'] = new \Symfony\Component\HttpFoundation\Session\Session($this->get('session.storage.php_bridge'), new \Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag(), new \Symfony\Component\HttpFoundation\Session\Flash\FlashBag());
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/html/achagua/sistema/app/sesiones');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/html/achagua/sistema/app/cache/dev/sessions');
    }
    ...
    /**
     * Gets the 'swiftmailer.mailer.potenza' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwiftmailer_Mailer_PotenzaService()
    {
        return $this->services['swiftmailer.mailer.potenza'] = new \Swift_Mailer($this->get('swiftmailer.mailer.potenza.transport'));
    }

    /**
     * Gets the 'swiftmailer.mailer.potenza.plugin.messagelogger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwiftmailer_Mailer_Potenza_Plugin_MessageloggerService()
    {
        return $this->services['swiftmailer.mailer.potenza.plugin.messagelogger'] = new \Swift_Plugins_MessageLogger();
    }

    /**
     * Gets the 'swiftmailer.mailer.potenza.spool' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwiftmailer_Mailer_Potenza_SpoolService()
    {
        return $this->services['swiftmailer.mailer.potenza.spool'] = new \Swift_MemorySpool();
    }

    /**
     * Gets the 'swiftmailer.mailer.potenza.transport' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwiftmailer_Mailer_Potenza_TransportService()
    {
        $this->services['swiftmailer.mailer.potenza.transport'] = $instance = new \Swift_Transport_SpoolTransport($this->get('swiftmailer.mailer.potenza.transport.eventdispatcher'), $this->get('swiftmailer.mailer.potenza.spool'));

        $instance->registerPlugin($this->get('swiftmailer.mailer.potenza.plugin.messagelogger'));

        return $instance;
    }

    /**
     * Gets the 'swiftmailer.mailer.potenza.transport.real' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwiftmailer_Mailer_Potenza_Transport_RealService()
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('e6cc0307ed9a17cb71408c4735142f0e_1'), 1 => $this->get('e6cc0307ed9a17cb71408c4735142f0e_2'), 2 => $this->get('e6cc0307ed9a17cb71408c4735142f0e_3')));
        $a->setUsername('contactenospotenza@grupodellano.com');
        $a->setPassword('Potenza1');
        $a->setAuthMode('login');

        $this->services['swiftmailer.mailer.potenza.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer($this->get('swiftmailer.transport.replacementfactory')), array(0 => $a), $this->get('swiftmailer.mailer.potenza.transport.eventdispatcher'));
    ...
    /**
     * Gets the 'swiftmailer.mailer.prisma' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Swift_Mailer A Swift_Mailer instance.
     */
    protected function getSwiftmailer_Mailer_PrismaService()
    {
        return $this->services['swiftmailer.mailer.prisma'] = new \Swift_Mailer($this->get('swiftmailer.mailer.prisma.transport'));
    }

    /**
     * Gets the 'swiftmailer.mailer.prisma.plugin.messagelogger' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Swift_Plugins_MessageLogger A Swift_Plugins_MessageLogger instance.
     */
    protected function getSwiftmailer_Mailer_Prisma_Plugin_MessageloggerService()
    {
        return $this->services['swiftmailer.mailer.prisma.plugin.messagelogger'] = new \Swift_Plugins_MessageLogger();
    }

    /**
     * Gets the 'swiftmailer.mailer.prisma.spool' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Swift_MemorySpool A Swift_MemorySpool instance.
     */
    protected function getSwiftmailer_Mailer_Prisma_SpoolService()
    {
        return $this->services['swiftmailer.mailer.prisma.spool'] = new \Swift_MemorySpool();
    }

    /**
     * Gets the 'swiftmailer.mailer.prisma.transport' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Swift_Transport_SpoolTransport A Swift_Transport_SpoolTransport instance.
     */
    protected function getSwiftmailer_Mailer_Prisma_TransportService()
    {
        $this->services['swiftmailer.mailer.prisma.transport'] = $instance = new \Swift_Transport_SpoolTransport($this->get('swiftmailer.mailer.prisma.transport.eventdispatcher'), $this->get('swiftmailer.mailer.prisma.spool'));

        $instance->registerPlugin($this->get('swiftmailer.mailer.prisma.plugin.messagelogger'));

        return $instance;
    }

    /**
     * Gets the 'swiftmailer.mailer.prisma.transport.real' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Swift_Transport_EsmtpTransport A Swift_Transport_EsmtpTransport instance.
     */
    protected function getSwiftmailer_Mailer_Prisma_Transport_RealService()
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('e6cc0307ed9a17cb71408c4735142f0e_1'), 1 => $this->get('e6cc0307ed9a17cb71408c4735142f0e_2'), 2 => $this->get('e6cc0307ed9a17cb71408c4735142f0e_3')));
        $a->setUsername('lmrubio@grupodellano.com');
        $a->setPassword('Admgmail2105.');
        $a->setAuthMode('login');

        $this->services['swiftmailer.mailer.prisma.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer($this->get('swiftmailer.transport.replacementfactory')), array(0 => $a), $this->get('swiftmailer.mailer.prisma.transport.eventdispatcher'));
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/var/www/html/achagua/sistema/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/html/achagua/sistema/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/html/achagua/sistema/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/var/www/html/achagua/sistema/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/html/achagua/sistema/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/var/www/html/achagua/sistema/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/var/www/html/achagua/sistema/app/Resources/TwigBundle/views', 'Twig');
        $instance->addPath('/var/www/html/achagua/sistema/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/var/www/html/achagua/sistema/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/html/achagua/sistema/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/html/achagua/sistema/src/Llanogas/LlanogasBundle/Resources/views', 'LlanogasLlanogas');
        $instance->addPath('/var/www/html/achagua/sistema/src/Reportes/ReportesBundle/Resources/views', 'Reportes');
        $instance->addPath('/var/www/html/achagua/sistema/src/Libranza/LibranzaBundle/Resources/views', 'Libranza');
        $instance->addPath('/var/www/html/achagua/sistema/src/Administracion/AdministracionBundle/Resources/views', 'AdministracionAdministracion');
        $instance->addPath('/var/www/html/achagua/sistema/src/Externo/FinanciacionesBundle/Resources/views', 'ExternoFinanciaciones');
        $instance->addPath('/var/www/html/achagua/sistema/src/Nominaciones/NominacionesBundle/Resources/views', 'NominacionesNominaciones');
        $instance->addPath('/var/www/html/achagua/sistema/src/Agendamiento/AgendamientoBundle/Resources/views', 'AgendamientoAgendamiento');
        $instance->addPath('/var/www/html/achagua/sistema/src/Reial/ReialBundle/Resources/views', 'ReialReial');
        $instance->addPath('/var/www/html/achagua/sistema/src/Rugii/RugiiBundle/Resources/views', 'RugiiRugii');
        $instance->addPath('/var/www/html/achagua/sistema/src/Dorbi/DorbiBundle/Resources/views', 'DorbiDorbi');
        $instance->addPath('/var/www/html/achagua/sistema/src/Bioagricola/BioagricolaBundle/Resources/views', 'BioagricolaBioagricola');
        $instance->addPath('/var/www/html/achagua/sistema/src/Contacto/ContactoBundle/Resources/views', 'ContactoContacto');
        $instance->addPath('/var/www/html/achagua/sistema/src/Homafo/HomafoBundle/Resources/views', 'HomafoHomafo');
        $instance->addPath('/var/www/html/achagua/sistema/src/GestionCartera/GestionCarteraBundle/Resources/views', 'GestionCarteraGestionCartera');
        $instance->addPath('/var/www/html/achagua/sistema/src/LiquidacionyNotas/LiquidacionyNotasBundle/Resources/views', 'LiquidacionyNotasLiquidacionyNotas');
        $instance->addPath('/var/www/html/achagua/sistema/src/Aprovechamiento/AprovechamientoBundle/Resources/views', 'AprovechamientoAprovechamiento');
        $instance->addPath('/var/www/html/achagua/sistema/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/var/www/html/achagua/sistema/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/var/www/html/achagua/sistema/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/var/www/html/achagua/sistema/app/Resources/views');
        $instance->addPath('/var/www/html/achagua/sistema/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/html/achagua/sistema/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/var/www/html/achagua/sistema/app/cache/dev/assetic/assets');
    }
    ...
    /**
     * Gets the 'e6cc0307ed9a17cb71408c4735142f0e_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getE6cc0307ed9a17cb71408c4735142f0e1Service()
    {
        return $this->services['e6cc0307ed9a17cb71408c4735142f0e_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'e6cc0307ed9a17cb71408c4735142f0e_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getE6cc0307ed9a17cb71408c4735142f0e2Service()
    {
        return $this->services['e6cc0307ed9a17cb71408c4735142f0e_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'e6cc0307ed9a17cb71408c4735142f0e_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getE6cc0307ed9a17cb71408c4735142f0e3Service()
    {
        return $this->services['e6cc0307ed9a17cb71408c4735142f0e_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    /**
     * Gets the 'swiftmailer.mailer.potenza.transport.eventdispatcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSwiftmailer_Mailer_Potenza_Transport_EventdispatcherService()
    {
        return $this->services['swiftmailer.mailer.potenza.transport.eventdispatcher'] = new \Swift_Events_SimpleEventDispatcher();
    }

    /**
     * Gets the 'swiftmailer.mailer.prisma.transport.eventdispatcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return Swift_Events_SimpleEventDispatcher A Swift_Events_SimpleEventDispatcher instance.
     */
    protected function getSwiftmailer_Mailer_Prisma_Transport_EventdispatcherService()
    {
        return $this->services['swiftmailer.mailer.prisma.transport.eventdispatcher'] = new \Swift_Events_SimpleEventDispatcher();
    }

    /**
     * Gets the 'swiftmailer.transport.replacementfactory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return Swift_StreamFilters_StringReplacementFilterFactory A Swift_StreamFilters_StringReplacementFilterFactory instance.
     */
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/html/achagua/sistema/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/var/www/html/achagua/sistema/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/html/achagua/sistema/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/html/achagua/sistema/app/cache/dev',
            'kernel.logs_dir' => '/var/www/html/achagua/sistema/app/logs',
            'kernel.bundles' => array(
                ...
                'LlanogasLlanogasBundle' => 'Llanogas\\LlanogasBundle\\LlanogasLlanogasBundle',
                'ReportesBundle' => 'Reportes\\ReportesBundle\\ReportesBundle',
                'LibranzaBundle' => 'Libranza\\LibranzaBundle\\LibranzaBundle',
                'AdministracionAdministracionBundle' => 'Administracion\\AdministracionBundle\\AdministracionAdministracionBundle',
                'ExternoFinanciacionesBundle' => 'Externo\\FinanciacionesBundle\\ExternoFinanciacionesBundle',
                'NominacionesNominacionesBundle' => 'Nominaciones\\NominacionesBundle\\NominacionesNominacionesBundle',
                'AgendamientoAgendamientoBundle' => 'Agendamiento\\AgendamientoBundle\\AgendamientoAgendamientoBundle',
                'ReialReialBundle' => 'Reial\\ReialBundle\\ReialReialBundle',
                'RugiiRugiiBundle' => 'Rugii\\RugiiBundle\\RugiiRugiiBundle',
                'DorbiDorbiBundle' => 'Dorbi\\DorbiBundle\\DorbiDorbiBundle',
                'BioagricolaBioagricolaBundle' => 'Bioagricola\\BioagricolaBundle\\BioagricolaBioagricolaBundle',
                'ContactoContactoBundle' => 'Contacto\\ContactoBundle\\ContactoContactoBundle',
                'HomafoHomafoBundle' => 'Homafo\\HomafoBundle\\HomafoHomafoBundle',
                'GestionCarteraGestionCarteraBundle' => 'GestionCartera\\GestionCarteraBundle\\GestionCarteraGestionCarteraBundle',
                'LiquidacionyNotasLiquidacionyNotasBundle' => 'LiquidacionyNotas\\LiquidacionyNotasBundle\\LiquidacionyNotasLiquidacionyNotasBundle',
                'AprovechamientoAprovechamientoBundle' => 'Aprovechamiento\\AprovechamientoBundle\\AprovechamientoAprovechamientoBundle',
            ...
            'debug.container.dump' => '/var/www/html/achagua/sistema/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/var/www/html/achagua/sistema/app/sesiones',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/var/www/html/achagua/sistema/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/var/www/html/achagua/sistema/app/cache/dev/profiler',
            ...
            'router.resource' => '/var/www/html/achagua/sistema/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/html/achagua/sistema/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.mailer.potenza.transport.name' => 'smtp',
            'swiftmailer.mailer.potenza.delivery.enabled' => true,
            'swiftmailer.mailer.potenza.transport.smtp.encryption' => 'tls',
            'swiftmailer.mailer.potenza.transport.smtp.port' => 25,
            'swiftmailer.mailer.potenza.transport.smtp.host' => 'smtp.gmail.com',
            'swiftmailer.mailer.potenza.transport.smtp.username' => 'contactenospotenza@grupodellano.com',
            'swiftmailer.mailer.potenza.transport.smtp.password' => 'Potenza1',
            'swiftmailer.mailer.potenza.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.potenza.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.potenza.transport.smtp.source_ip' => NULL,
            'swiftmailer.spool.potenza.memory.path' => '/var/www/html/achagua/sistema/app/cache/dev/swiftmailer/spool/potenza',
            'swiftmailer.mailer.potenza.spool.enabled' => true,
            'swiftmailer.mailer.potenza.plugin.impersonate' => NULL,
            'swiftmailer.mailer.potenza.single_address' => NULL,
            'swiftmailer.spool.enabled' => true,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => NULL,
            'swiftmailer.mailer.prisma.transport.name' => 'smtp',
            'swiftmailer.mailer.prisma.delivery.enabled' => true,
            'swiftmailer.mailer.prisma.transport.smtp.encryption' => 'tls',
            'swiftmailer.mailer.prisma.transport.smtp.port' => 25,
            'swiftmailer.mailer.prisma.transport.smtp.host' => 'smtp.gmail.com',
            'swiftmailer.mailer.prisma.transport.smtp.username' => 'lmrubio@grupodellano.com',
            'swiftmailer.mailer.prisma.transport.smtp.password' => 'Admgmail2105.',
            'swiftmailer.mailer.prisma.transport.smtp.auth_mode' => 'login',
            'swiftmailer.mailer.prisma.transport.smtp.timeout' => 30,
            'swiftmailer.mailer.prisma.transport.smtp.source_ip' => NULL,
            'swiftmailer.spool.prisma.memory.path' => '/var/www/html/achagua/sistema/app/cache/dev/swiftmailer/spool/prisma',
            'swiftmailer.mailer.prisma.spool.enabled' => true,
            'swiftmailer.mailer.prisma.plugin.impersonate' => NULL,
            'swiftmailer.mailer.prisma.single_address' => NULL,
            'swiftmailer.mailers' => array(
                'potenza' => 'swiftmailer.mailer.potenza',
                'prisma' => 'swiftmailer.mailer.prisma',
            ),
            'swiftmailer.default_mailer' => 'potenza',
            ...
            'assetic.cache_dir' => '/var/www/html/achagua/sistema/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/var/www/html/achagua/sistema/app/../web',
            'assetic.write_to' => '/var/www/html/achagua/sistema/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/html/achagua/sistema/app/cache/dev/doctrine/orm/Proxies',

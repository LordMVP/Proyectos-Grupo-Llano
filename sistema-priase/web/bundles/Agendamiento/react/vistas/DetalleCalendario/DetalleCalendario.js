...
//Rutas entre la vista Solicitud Agendamiento y Symfony-DetalleCalendarioController
...
class DetalleCalendario extends Component {
    ...
    funciones = [
        ...
        { texto: 'consultar', callback: this.nuevo },
    ]
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <h1>Consultar información calendario</h1>        
...
export { VistaRedux as RDetalleCalendario }

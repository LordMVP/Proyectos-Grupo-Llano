            ...
            <div className="layout">
                <div className="layout__titulo">
                    <h1>
                        ...
                        {sesion
                            ? sesion.empresa
                            : 'Sistema de información Prisma'}
                    </h1>
                </div>

                <div className="layout__contenedor">
                    <div className="layout__contenedor__menu">
                        <Menu
                            actualizarProgramas={actualizarProgramas}
                            opciones={_menu}
                            sesion={this.props.sesion}
                        />
                    </div>

                    <div className="layout__contenedor__programa">
                        {/* <h2>{tituloPrograma}</h2> */}
                        <div className="layout__contenedor__programa__interfaz">
                            {children}
                        </div>
                    </div>
                </div>

 ...
 */
class ListExcepcionesConsolidacionMetas extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>
                    ...
                    <br />
                    <BootstrapTable bootstrap4 wrapperClasses="table-responsive" rowClasses="text-nowrap" striped bordered hover keyField='cmete_idregistro' data={data} columns={this.state.columnas}  pagination={paginationFactory()} filter={filterFactory()} filterPosition="top" noDataIndication="No hay registros disponible" />
...
ListExcepcionesConsolidacionMetas.propTypes = {
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(ListExcepcionesConsolidacionMetas);
export { VistaRedux as RVistaListExcepcionesConsolidacionMetas };
...
import { RVistaFormModalConceptosDeterioro, RVistaListResumenConsultaDeterioro } from '../index';
 ...
 */
class ListConsultaDeterioro extends Component {
  ...
  */
    ...
    handleExcel = () => {
        ...
        if (!validacion.respuesta) {
            ...
            deterioroNiff.generarExcel(formEdicionDN.per_ideregistro,formEdicionDN.tipo_deterioro).then((reponseDatoMG) => {
                ...
                if (reponseDatoMG.status== 200) {
                    ...
                    link.download = 'Lista_Consulta_Deterioro.xlsx'
                    link.click();
            ...
            <Fragment>
                    ...
                    <div className="relative-parent">
                        ...
                        <ToolkitProvider
                            ...
                            exportCSV={ 
                                {
                                    fileName: 'Lista_Consulta_Deterioro.csv',
                                    noAutoBOM: false,
                        ...
                        <br /><RVistaListResumenConsultaDeterioro/> 
...
ListConsultaDeterioro.propTypes = {
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(ListConsultaDeterioro);
export { VistaRedux as RVistaListConsultaDeterioro };
...
/**
 * Componente para listar detalle tabla comisional rangos
 */
class DetalleTablaComisionalRango extends Component {
    ...
    columnas = [{
        dataField: 'tcomd_valordesde',
        text: 'Desde',
        sort: true
    },  {
        dataField: 'tcomd_valorhasta',
        text: 'Hasta',
        sort: true
    },{
        dataField: 'tcomd_valorporcentaje',
        text: 'Porcentaje',
        sort: true
    },{
        dataField: 'df2',
    ...
    agregarItem = () => {
        ...
        const validacion = validaFormulario.validaFormTComRango(formEdicion);
                ...
                <Row className="elemento-center">
                    <Col xs={3}>
                        <Form.Group >
                            ...
                            <Form.Control type="number" required name="tcomd_valordesde"  onChange={this.handleChange} value={formEdicion.tcomd_valordesde} placeholder="Desde"  />              
                        </Form.Group>
                    </Col>
                    <Col xs={3}>
                        <Form.Group >
                            <Form.Label>Hasta <span className="obligatorio">*</span></Form.Label>
                            <Form.Control type="number" required name="tcomd_valorhasta" onChange={this.handleChange} value={formEdicion.tcomd_valorhasta} placeholder="Hasta"  />              
                        </Form.Group>
                    </Col>
                    <Col xs={3}>
                        <Form.Group >
                            <Form.Label>% Reconocimiento <span className="obligatorio">*</span></Form.Label>
                            <Form.Control type="number" required name="tcomd_valorporcentaje" onChange={this.handleChange} value={formEdicion.tcomd_valorporcentaje} placeholder="% Reconocimiento"  />              
                        </Form.Group>
                    </Col>
                    <Col xs={2}>
                        <Form.Group >
...
DetalleTablaComisionalRango.propTypes = {
...
const mapDispatchToProps = dispatch => ({
    ...
    listarItem() {
        dispatch({
            ...
            payload: "Listar items detalle tabla comisión rango"
        })
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(DetalleTablaComisionalRango);
export { VistaRedux as RVistaDetalleTablaComisionalRango };
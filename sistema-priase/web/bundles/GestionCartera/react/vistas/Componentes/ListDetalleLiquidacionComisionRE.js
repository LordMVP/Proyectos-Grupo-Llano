 ...
 */
class ListDetalleLiquidacionComisionRE extends Component {
    ...
    columnas = [{
        ...
        dataField: 'drec_ideregistr',
        text: 'Recaudo id',
        sort: true
    }, {
        dataField: 'valor_recaudo',
        text: 'Valor Recaudo',
        sort: true
    }, {
  ...
  */
    ...
    render() {
        const { dataDetalleLCRE } = this.props.gestionCarteraState;
        ...
        return (
            <Fragment>
                <RVistaEdicionNovedadVisita ocultarVentana={this.ocultarVentana} />
                    ...
                    <h1>Lista Detalle Comisión por Recaudo</h1>
                    <div className="customHr">.</div>
                    <br />
                 
                <ToolkitProvider
                    keyField='dmliq_idregistro' 
                    data={dataDetalleLCRE} 
                    columns={this.state.columnas} 
                    exportCSV={ 
                        {
                            fileName: 'Lista_Detalle_Liquidacion_Recaudo.csv',
                            noAutoBOM: false,
...
ListDetalleLiquidacionComisionRE.propTypes = {
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(ListDetalleLiquidacionComisionRE);
export { VistaRedux as RVistaListDetalleLiquidacionComisionRE };
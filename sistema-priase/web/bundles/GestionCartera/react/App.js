...
import { getToken, parsearJSON } from './global/util_nominaciones';
...
class App extends Component {
  ...
  mostrarToast = (respuesta) => {
   ...
   /* if (data.codigoRespuesta >= 400 && data.codigoRespuesta <= 500) {
    ...
    if (data.codigoRespuesta === 200 || data.codigoRespuesta === 201) {

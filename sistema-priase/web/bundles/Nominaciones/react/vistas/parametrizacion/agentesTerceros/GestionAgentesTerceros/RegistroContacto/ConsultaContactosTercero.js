...
class ConsultaContactosTercero extends Component {
  ...
  render() {
    return (
      <div className='consulta-tramos'>
        ...
        <Input
          cols={12}
          label='Buscar contactos por Documento o Nombre:'
        ...
        <ConsultaGenerica
          ...
          rutaConsulta={RUTAS_API.PARAMETRIZACION.GESTION_AGENTES_TERCEROS.CONSULTAR_TODOS_LOS_CONTACTOS}
        />
...
ConsultaContactosTercero.propTypes = {
...
ConsultaContactosTercero.defaultProps = {
  esModal: false,
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(ConsultaContactosTercero);

export { VistaRedux as RConsultaContactosTercero };

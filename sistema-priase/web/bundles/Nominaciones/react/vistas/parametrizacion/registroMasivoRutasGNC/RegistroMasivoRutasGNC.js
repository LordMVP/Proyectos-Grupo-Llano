...
import './RegistroMasivoRutasGNC.scss';

class RegistroMasivoRutasGNC extends Component {
  ...
  onSubirArchivo = () => {
    ...
    axios.post(RUTAS_API.PARAMETRIZACION.SUBIR_ARCHIVO_RUTAS_GNC, data, configuracion)
      .then((respuesta) => {
  ...
  /**
   * Método encargado de mostrar los errores que se puedan generar al subir el archivo
   */
  ...
  render() {
    return (
      <div className='registro-masivo-rutas'>
        <div className="d-flex justify-content-center mt-3">
          <Botonera funciones={this.obtenerFunciones()} />
        </div>
        <div className="row mt-4">
          <div className='form-group col-4'>
            <label htmlFor='txtArchivoRutas'>Archivo de Rutas GNC:</label>
          ...
          <div className='mt-3 d-flex justify-content-center registro-masivo-rutas__ejemplo'>
            <div>
              <p>Cabecera de Ejemplo del Archivo</p>
              <pre>
                nombre, tipo (G=GNC,C=Conexión)
              </pre>
            </div>
          </div>
...
RegistroMasivoRutasGNC.propTypes = {
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(RegistroMasivoRutasGNC);

export { VistaRedux as RRegistroMasivoRutasGNC };

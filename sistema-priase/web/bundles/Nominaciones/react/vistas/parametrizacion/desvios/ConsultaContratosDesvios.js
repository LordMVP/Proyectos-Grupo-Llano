...
class ConsultaContratosDesvios extends Component {
  ...
  onBuscar = () => {
    ...
    this.consultaGenerica.getWrappedInstance()._buscar({ 'criterio': this.state.criterio.trim(), 'ruta': ruta });
  };
  ...
  render() {
    return (
      <div className='consulta-tramos'>
        ...
        <Input
          cols={12}
          label='Consultar contratos por número, nombre del tercero:'
        ...
        <ConsultaGenerica
          ...
          rutaConsulta={RUTAS_API.PARAMETRIZACION.GESTION_DESVIOS.CONSULTAR_CONTRATOS}
        />
      </div>
    );
  };
...
ConsultaContratosDesvios.propTypes = {
...
ConsultaContratosDesvios.defaultProps = {
  esModal: false
};
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(ConsultaContratosDesvios);

export { VistaRedux as RConsultaContratosDesvios };

...
class ConsultaTramos extends Component {
    ...
    return (
      <div className='consulta-tramos'>
        ...
        <ConsultaGenerica
          ...
          interfazGestion={RUTAS_VISTA.GESTION_TRAMOS.url}
          rutaConsulta={RUTAS_API.PARAMETRIZACION.TRAMOS.CONSULTAR_TRAMOS}
        />
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(ConsultaTramos);

export { VistaRedux as RConsultaTramos };

...
class ConsultaContratoTransporte extends Component {
  ...
  render() {
    return (
      <div className='consulta-tramos'>
        ...
        <Input
          cols={12}
          label='Buscar por por nombre del tercero:'
        ...
        <ConsultaGenerica
          ...
          rutaConsulta={RUTAS_API.PARAMETRIZACION.GESTION_PUNTOS_CONSUMO.CONSULTAR_CONTRATO_TRANSPORTE}
        />
...
ConsultaContratoTransporte.propTypes = {
...
ConsultaContratoTransporte.defaultProps = {
  esModal: false,
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(ConsultaContratoTransporte);

export { VistaRedux as RConsultaContratoTransporte };

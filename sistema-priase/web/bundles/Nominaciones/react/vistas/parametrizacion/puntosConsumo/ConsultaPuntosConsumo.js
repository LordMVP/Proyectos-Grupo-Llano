...
class ConsultaPuntosConsumo extends Component {

  consultaGenerica = null;
  columnas = [
    {
      Header: 'Puntos de Consumo',
      columns: [
        {
          Header: 'Nombre',
          accessor: 'ptcoNombre'
        ...
        {
          Header: 'Codigo Gestor',
          accessor: 'ptcoCodigogestor'
        }
      ]
    }
  ];
  ...
  onBuscar = () => {
    ...
    this.consultaGenerica.getWrappedInstance()._buscar({ 'criterio': criterio });
  };
  ...
  render() {
    return (
      <div className='consulta-tramos'>
        ...
        <Input
          cols={12}
          label='Buscar Puntos de Consumo por nombre:'
        ...
        <ConsultaGenerica
          {...this.props}
          idEntidad='ptcIderegistro'
          columnas={this.columnas}
          ref={ref => this.consultaGenerica = ref}
          interfazGestion={RUTAS_VISTA.GESTION_PUNTOS_CONSUMO.url}
          rutaConsulta={RUTAS_API.PARAMETRIZACION.GESTION_PUNTOS_CONSUMO.CONSULTAR_PUNTOS_CONSUMO}
        />
...
ConsultaPuntosConsumo.propTypes = {
  history: PropTypes.object,
  esModal: PropTypes.bool,
  seleccionarEntidad: PropTypes.func
};

ConsultaPuntosConsumo.defaultProps = {
  esModal: false
};
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(ConsultaPuntosConsumo);

export { VistaRedux as RConsultaPuntosConsumo };

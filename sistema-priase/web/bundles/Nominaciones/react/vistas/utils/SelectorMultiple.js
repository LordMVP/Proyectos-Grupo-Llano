...
class SelectorMultiple extends Component {
        ...
        <div className="input-group mb-3">
          ...
          <div className="input-group-prepend">
            <button
              ...
              disabled={this.props.extra && this.props.extra.disabled}
              ...
              </thead><tbody>
            {
              this.props.lista.map(registro => {
                ...
                return (
                  //<div key={`item_selector_${getProp(registro, this.props.propValor, null)}`}>
                  <tr>
                    <td><input type="checkbox" value={getProp(registro, this.props.propValor, null)} checked={registro.seleccionado || false} onChange={this.seleccionarItem} /></td>
                    <td><span> {getProp(registro, this.props.propTexto, 'No definido')}</span></td>
                    <td><span> {getProp(registro, 'conAbreviatura', 'No definido')}</span></td>
                  </tr>
  ...
  render() {
    return (
      <Fragment>
        {this.renderSelector()}
        {this.props.titulo.trim()=="Variables"
        ?
        this.renderModalSelectorVariables()
        :

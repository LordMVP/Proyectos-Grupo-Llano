const ColsTablaSuscripsRDeudaAdicionar = [
    {
    ...
    {
        Header: "Valor a ajustar",
        accessor: "valorAjustar",
        minWidth: 180,
        headerClassName: "headerTableTextStyle",
    },
    {
        Header: "Nuevo saldo emitido",
        accessor: "saldoAdiciona",
        minWidth: 180,
        headerClassName: "headerTableTextStyle",
    },
];

export default ColsTablaSuscripsRDeudaAdicionar;
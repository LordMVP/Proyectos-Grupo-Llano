import { MOSTRAR_ALERTA, MOSTRAR_CARGADOR, OCULTAR_ALERTA, ACTUALIZAR_PROGRAMAS, MOSTRAR_PROGRAMA_MODAL, OCULTAR_PROGRAMA_MODAL } from './TiposAcciones';
...
export const mostrarProgramaModal = (componente, callbackCierre) => dispatch => {
  dispatch({

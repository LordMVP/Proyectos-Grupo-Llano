...
import './GenComTercerosForm.scss';

class GenComTercerosForm extends Component {
  state = {
    terceros: [],
  ...
  render() {
    ...
    // Modifica: Entidad recaudadora 
    return (
      <Fragment>
        <h3><strong>Convenio de Homologacion</strong></h3><br/>
        <div className="row">
          <div className="col-3">
...
const VistaRedux = connect(mapStateToProps, mapDispatchToProps)(GenComTercerosForm);

export { VistaRedux as RGenComTercerosForm };
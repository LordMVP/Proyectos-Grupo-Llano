...
app.controller('FacturadoVsRecaudadoControllerAngular', function ($scope, $http, ModalService, modelo) {
    $scope.modelo = modelo;
    $scope.init = function () {
    ...
    /**
     * Consulta los tipo de uno de la empresa
     */
    $http.get("../util/getJsonTiposUsoEmpresa").then(function (response) {
        $scope.tipousos = response.data.tiposUso;
    });
    ...
    $scope.cargarLiquidaciones = function () {
        $http.post("../util/getJsonLiquidacionesFacturadas", $scope.info).then(function (response) {
            $scope.liquidaciones = response.data.liquidaciones;
        });
    };
    ...
    $scope.generarReporte = function () {
        ...
        if ($scope.reporte.$valid) {
            ...
            $http.post("generarReporteFacturadoRecaudado", $scope.info).then(function (response) {

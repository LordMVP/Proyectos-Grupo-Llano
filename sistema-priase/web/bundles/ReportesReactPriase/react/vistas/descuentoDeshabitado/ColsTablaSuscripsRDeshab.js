const ColsTablaSuscripsRDeshab = [
    {
    ...
    {
        Header: "Tarifa final deshabitada",
        accessor: "tarifaFinalDescuento",
        minWidth: 180,
        headerClassName: "headerTableTextStyle",
    },
    {
        Header: "Total descuento deshabitado",
...
export default ColsTablaSuscripsRDeshab;
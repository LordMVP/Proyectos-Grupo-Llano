...
const ColsTablaDetalleDeudaEliminar = [
  {
  ...
  {
    Header: "Valor a eliminar",
    accessor: "valorAAjustar",
    minWidth: 140,
    Cell: (row) => <div style={{ textAlign: "center" }}>{row.original.valorEmitidoFactura}</div>,
    headerClassName: "headerTableTextStyle",
  },

  {
    ...
    minWidth: 140,
    Cell: (row) => <div style={{ textAlign: "center" }}>{0}</div>,
    headerClassName: "headerTableTextStyle",
  },
];

export default ColsTablaDetalleDeudaEliminar;

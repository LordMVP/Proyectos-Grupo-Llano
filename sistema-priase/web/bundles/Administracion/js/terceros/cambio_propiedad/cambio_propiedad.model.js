...
var formatoterceropropiedad = {
    thead: [
        ...
        {'id': 'thCodigoAnterior', 'text': 'Cod. Anterior', 'sort': false, 'refer': 'codigoanterior', 'type': 'text'},
        ...
        {'id': 'thSuscriptor', 'text': 'Suscriptor', 'sort': false, 'refer': 'suscriptor', 'type': 'text'},
        {'id': 'thSusDescripcion', 'text': 'Descripcion', 'sort': false, 'refer': 'sus_descripcion', 'type': 'text'}
    ]
};
var formatopropiedad = {
    thead: [
        ...
        {'id': 'thTieneSuscripcion', 'text': 'Suscripcion', 'sort': false, 'refer': 'tienesuscr', 'type': 'text'},
        {'id': 'thCodigoAnterior', 'text': 'Codigo Anterior', 'sort': false, 'refer': 'codigoanterior', 'type': 'text'}
    ]
}
/** @namespace */
var cambioPropiedadModel = {
    terceropropiedad: [],

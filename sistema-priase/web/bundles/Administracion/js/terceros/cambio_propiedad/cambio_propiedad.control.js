...
var cambioPropiedadControl = {
    ...
    buscarMunicipio: function (data, success) {
        __cnn.ajax({
            url: '../../../ventas/constructoras/filtrar/consultar_municipios/',
            data: data,
            completado: success
        });
    }
    ...
    buscarBarrio: function (data, success) {
        __cnn.ajax({
            url: '../../../ventas/constructoras/filtrar/consultar_barrios/',
            data: data,
            completado: success
        });
    },
    filtrarTerceroPropiedad: function (data, success) {
        __cnn.ajax({
            url: '../cambio_propiedad/consultar_terceropropiedad/',
            data: data,
            completado: success
        });
    },
    filtrarPropiedad: function (data, success) {
        __cnn.ajax({
            url: '../cambio_propiedad/consultar_propiedad/',
            data: data,
            completado: success
        });
    },
    grabarPropiedad: function (data, success) {
        __cnn.ajax({
            url: '../cambio_propiedad/grabar_propiedad/',
            data: data,
            completado: success
        });
    }

...
/**
 * componente que carga el componente de la tabla de cruce de recaudos no aforado
 *
 * @param {object} props - propiedades del componente
 *  @param {object[]} props.data - informacion de la consulta de cruce recaudo no aforado
 * @returns {component}
 */
export default function TablaCruceRecuadoNA({ data }) {

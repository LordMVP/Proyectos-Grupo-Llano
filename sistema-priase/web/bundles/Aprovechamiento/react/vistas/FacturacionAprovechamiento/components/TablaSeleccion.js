 ...
 * @param {requestCallback} props.onAction - funcion de agregar un dato a la tabla seleccion
 * @param {requestCallback} props.deleteOneSelect - funcion que borra los datos de una selecciones en la tabla de selección
 * @param {object[]} props.dataNamesDocs - array con los numeros de documento de los terceros
 * @param {object[]} props.dataSelect - los datos a seleccionados
 * @returns {component}
 */

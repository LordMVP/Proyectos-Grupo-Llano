...
import DateBoxM from "../../Utils/Components/DateBoxM";
...
export default function FilterMenu({
  ...
  const onSubmit = () => {
    const stringInit = moment(initDate).format("MM-YYYY");
    const stringEnd = moment(endDate).format("MM-YYYY");

    getData({
      idTerceroList: REMOVE_DUPLICATES([...form.dsusId, ...form.codBefore]),
      endDate: stringInit,
      initialDate: stringEnd,
    });
  };

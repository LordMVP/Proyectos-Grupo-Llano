/* 
 * Plugin zelect de Jquery  
 * para implementación simplemente ejecutar la siguiente función de jquery   $('#idselector').zelect();
 * Para capturar un valor de un select $('#idselector').val();
 *  Para mas información verificar la documentación en https://github.com/mtkopone/zelect
 */

/* 
    Created on : 27 ene. 2022, 13:53:04
    Anexado por: Felipe Rodriguez
*/

/**
 * @fileOverview Archivo de control para generar notas automáticas por el método "calculada"
...
var notasControl = {
    ...
    consultarFacturasFiltro: function (data, completado) {
        __cnn.ajax({
            data: data,
            completado: completado,
            url: '../notas_automaticas/facturas/filtrar/'
        });
    },
    ...
    consultarDetallesFacturas: function (data, completado) {
        __cnn.ajax({
            data: data,
            completado: completado,
            url: '../notas_automaticas/facturas/detalles/'
        });
    },
     ...
     * @param  {Object} data       Parámetros de la petición (idfactura)
    ...
    /**
     * Aplica las notas en el servidor
    ...
    consultarConceptosAutocomplete: function (completado) {
        __cnn.ajax({
            completado: completado,
            url: '../notas_automaticas/conceptos/complete/'
        });
    },
    ...
    /**
     * Consulta la lista de errores en la aplicación
     * @param  {Function} completado Callback: función anónima ejecutada en la vista.
     * @returns {void}            
     */
    ...
    /**
     * Consulta los tipos de documento por la suscripción
     * @param  {Object} data    Datos de la petición: idsuscripcion
     * @param  {Functión} success Callback: onConsultarTipoDocumentoCompleto
     * @returns {void}         
     */
    ...
    /**
     * Elimina las tablas temporales antes de iniciar el programa.
     * @param  {Function} completado Callback: función anónima invocada desde la vista.
     * @returns {void}            
     */
    ...
    /**
     * Busca un concepto por su id en la lista de facturas 
     * @param  {Number} idConcepto Id del concepto a buscar
     * @returns {Boolean}            Si encuentra retorna true, de lo contrario false
     */

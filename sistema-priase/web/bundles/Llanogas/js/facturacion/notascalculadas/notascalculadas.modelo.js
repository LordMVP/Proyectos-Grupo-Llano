...
var formatoLiquidacionConcepto = {
    thead:[
        ...
        {'id':'thConcepto', 'text':'Concepto', 'sort':false, 'refer':'concepto', 'type':'text', 'valueField': 'idconcepto','style':{'width':'45%'}},
...
var formatoConceptosProcesados = {
    thead:[
        ...
        {'id':'thValorSaldo', 'text':'Valor Saldo', 'refer':'notasaldo', 'type':'currency'}
...
var formatoConceptosInformativos = {
	thead:[
		{'id':'thFactura', 'text':'Id Factura', 'refer':'idfactura', 'type':'text'},
		{'id':'thNumeroFactura', 'text':'Núm. Factura', 'refer':'numerofactura', 'type':'text'},
		{'id':'thConcepto', 'text':'Cód. Concepto', 'refer':'idconcepto', 'type':'text'},
		{'id':'thConcepto', 'text':'Descripción', 'refer':'concepto', 'type':'text'},
		{'id':'thValorInicial', 'text':'Valor Inicial', 'refer':'valorinicial', 'type':'numeric'},
		{'id':'thValorLiquidado', 'text':'Valor Liquidado', 'refer':'valorliquidado', 'type':'numeric'}
	]
};

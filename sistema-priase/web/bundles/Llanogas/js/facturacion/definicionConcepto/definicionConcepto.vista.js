...
var definicionVista = {
    ...
    mostrarConceptosCompleto: function(data) {
        ...
        $('#cmbDeshabitado').val((data.deshabitado)?data.deshabitado:'N');
        $('#cmbPuertaPuerta').val((data.puertapuerta)?data.puertapuerta:'N');
        $('#cmbTarifaPlena').val((data.tarifaplena)?data.tarifaplena:'N' );
        $('#cmbHomologacion').val((data.homologacion)?data.homologacion:'N');
        $('#cmbAforadoaseo').val((data.aforadoaseo)?data.aforadoaseo:'N');
        $('#cmbAforadoTercero').val((data.aforadotercero)?data.aforadotercero:'N');
        $('#cmbAplicaDINC').val((data.aplicadinc)?data.aplicadinc:'N');

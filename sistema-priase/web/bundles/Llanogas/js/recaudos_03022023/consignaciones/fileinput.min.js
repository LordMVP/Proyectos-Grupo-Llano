...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            removeIcon: '<i class="fa fa-trash-o fa-x1"></i>',
            removeClass: 'btnSimple',
            removeTitle: 'Remover Archivo',
            uploadIcon: '<i class="fa fa-upload fa-x1"></i>',
            uploadClass: 'btnSimple',
            uploadTitle: 'Subir Archivo',
            indicatorNew: '<i class="fa fa-hand-o-down text-warning"></i>',
            indicatorSuccess: '<i class="fa fa-check-circle-o file-icon-large text-success"></i>',
            indicatorError: '<i class="fa fa-exclamation-circle text-danger"></i>',
            indicatorLoading: '<i class="fa fa-hand-o-up text-muted"></i>',
            indicatorNewTitle: 'No se ha subido aún',
        ...
        tMain1 = '{preview}\n' +
            ...
            '   {caption}\n' +
            '   <div class="input-group-btn divBotones">\n' +
            '       {remove}\n' +
            '       {cancel}\n' +
...
/*        tModal = '<div id="{id}" class="modal fade">\n' +
        ...
        tActions = '<div class="file-actions">\n' +
            '    <div id="divBotonesFooterUpload" class="file-footer-buttons divBotones">\n' +
            '        {upload}{delete}{other}' +
            '    </div>\n' +
    ...
    FileInput.prototype = {
                ...
                setTimeout(function () {
                    if (isEmpty(data) || isEmpty(data.error)) {
                        ...
                        self.raise('fileuploaded', [outData, previewId, i]);
                         $('#archivoAdjunto div[class="'+self.progressClass+'"]').text('100%')
        ...
        previewDefault: function (file, previewId, isDisabled) {
            ...
            if (isDisabled === true) {
                ...
                footer += '<div class="file-other-error text-danger"><i class="fa fa-exclamation-circle"></i></div>';
            }
        ...
        readFiles: function (files) {
            ...
            var self = this, $el = self.$element, $preview = self.$preview, reader = self.reader,
                ...
                throwError = function (msg, file, previewId, index) {
                    ...
                    var footer = self.$preview.find('#'+previewId);
                    footer.find('.file-other-error').css('text-align','center');
                    footer.find('.file-other-error i').css({'color':'#F90', 'font-size':'12px'})
                                                      .addClass('fa-2x')
                                                      .attr('title', 'Este archivo no se almacenará')
                                                      .html('<span style="margin-left:5px;">Archivo inválido</span>');
                    footer.find('.file-thumbnail-footer .file-actions').hide(0);
                    __dom.lanzarAlerta('El archivo '+file.name+', no es válido, verifique los archivos e intente de nuevo', __app.mensajes.atencion);
                    $('.file-preview').removeClass('loading');
        ...
        updateFileDetails: function (numFiles) {
            ...
            if (self.isError) {
                ...
                $('.progress-bar .progress-bar-success').text('100%');
    ...
    $.fn.fileinput.defaults = {
        ...
        previewFileIcon: '<i class="fa fa-file-o fa-x1"></i>',
        browseIcon: '<i class="fa fa-folder-open fa-x1"></i> &nbsp;',
        browseClass: 'na',
        removeIcon: '<i class="fa fa-trash-o fa-x1"></i> ',
        removeClass: 'btnSimple',
        cancelIcon: '<i class="fa fa-ban fa-x1"></i> ',
        cancelClass: 'btnSimple',
        uploadIcon: '<i class="fa fa-upload fa-x1"></i> ',
        uploadClass: 'na',
        uploadUrl: null,
        uploadAsync: true,

...
var generarVista = {
    ...
    onConsultarResumenCompleto: function (data) {
        if (data.codigoRespuesta > 0) {
            fillTable('tblResumen', 'formatoResumen', data.resumencorrectos, 'Financiaciones correctas');
            }  
    ...
    limpiarFormulario: function () {
     ...
     /**
     * Genera el archivo plano de la cuotas a cobrar
     * @returns {void}
     */
    ...
    onDescargarInformeCompleto: function (data) {
        ...
        if (data.codigoRespuesta == 2 ) 
        {
            ...
            that.descargarArchivo(that.generarTexto(datos), 'cuotas.txt');  
            return;
         }  
    },

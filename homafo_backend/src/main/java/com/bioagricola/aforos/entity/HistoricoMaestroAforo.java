...
@Entity
@Table(name = "hmaf_histormaestroaforos", catalog=SchemaConstants.ASEO, schema=SchemaConstants.ASEO)
@Getter @Setter @NoArgsConstructor
public class HistoricoMaestroAforo implements BaseEntity{
	...
	public String getNombreTabla() {
		return "hmaf_histormaestroaforos";
	}

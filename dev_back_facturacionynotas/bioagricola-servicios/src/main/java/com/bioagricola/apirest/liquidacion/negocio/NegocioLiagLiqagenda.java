...
import com.bioagricola.apirest.modelo.manejadores.ManejadorLiagLiqagenda;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad LiagLiqagenda
 * @author GeneradorCRUD
 */
@Service
public class NegocioLiagLiqagenda extends NegocioAbstracto<LiagLiqagenda,LiagLiqagendaDTO> {

    @Autowired
    private ManejadorLiagLiqagenda manejadorLiagLiqagenda;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioLiagLiqagenda.class.getName());
    ...
    /**
     * Realiza un consulta en la entidad LiagLiqagenda aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal liagLiqagendaId>1&liagLiqagendaName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: liagLiqagendaId$ASC, liagLiqagendaName$DESC
     ...
     * @return Una lista de DAOs de los LiagLiqagenda que se consultaron con los parámetros enviados por el cliente
     ...
     */
    public List<LiagLiqagendaDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorLiagLiqagenda.consultar(filtros, ordenamiento, rango));
        // protected region Modifique el metodo consultar end
    }

    /**
     * Crea el liagLiqagenda que se pasa como parámetro en la base de datos.
     * 
     * @param liagLiqagendaDTO El DAO de la entidad LiagLiqagenda a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return La insntancia de LiagLiqagenda recién creado
     */
    public LiagLiqagendaDTO crear(LiagLiqagendaDTO liagLiqagendaDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", liagLiqagendaDTO);

        LiagLiqagenda liagLiqagenda = new LiagLiqagenda();
        copiarPropiedades(liagLiqagenda, liagLiqagendaDTO);
        
        manejadorLiagLiqagenda.save(liagLiqagenda);

        return liagLiqagendaDTO;
        // protected region Modifique el metodo crear end
    }

    /**
     * Actualiza en la base de datos el liagLiqagenda que se pasa como parámetro.
     * 
     * @param liagLiqagendaDTO El DAO de la entidad LiagLiqagenda a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return La instancia de la entidad LiagLiqagenda que ha sido actualizado
     */
    public LiagLiqagendaDTO actualizar(LiagLiqagendaDTO liagLiqagendaDTO){
        ...
        logService(this.getClass().getName(), "actualizar", liagLiqagendaDTO);

        LiagLiqagenda liagLiqagenda = manejadorLiagLiqagenda.getOne(liagLiqagendaDTO.getLiagIderegistr());                
        copiarPropiedades(liagLiqagenda, liagLiqagendaDTO);
    ...
    /**
     * Elimina el liagLiqagenda con el identificador que se pasa como parámetro.
     * 
     * @param liagIderegistr Valor del atributo del identificador de la instancia de la entidad  liagLiqagenda a eliminar
     * @return El identificador del liagLiqagenda que ha sido eliminado
     */
    public String eliminar(Integer liagIderegistr) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", liagIderegistr);
        manejadorLiagLiqagenda.deleteById(liagIderegistr);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(liagIderegistr));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorLiagLiqagenda.consultarTotalRegistros(filtros, 
                    rango));
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: liagLiqagendaId$ASC, liagLiqagendaName$DESC
     * @param atributo Nombre del atributo de la entidad LiagLiqagenda del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorLiagLiqagenda.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return LiagLiqagenda.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected LiagLiqagendaDTO instanciarDAO() {
        return new LiagLiqagendaDTO();
    }       

...
import com.bioagricola.apirest.liquidacion.negocio.NegocioFunFuncion;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.IFunFuncion;
import com.bioagricola.apirest.modelo.dtos.FunFuncionDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;


/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad FunFuncion
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/funfuncion")
public class ServicioFunFuncion implements IFunFuncion {

    @Autowired
    private NegocioFunFuncion negocioFunFuncion;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioFunFuncion.class.getName());
     ...
     */
    @GetMapping
    public List<FunFuncionDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioFunFuncion.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de FunFuncion recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public FunFuncionDTO crear(@RequestBody FunFuncionDTO funFuncionDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioFunFuncion.crear(funFuncionDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad FunFuncion que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public FunFuncionDTO actualizar(@RequestBody FunFuncionDTO funFuncionDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioFunFuncion.actualizar(funFuncionDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("funNombre") String funNombre) {
        // protected region Use esta region para su implementacion on begin

        return negocioFunFuncion.eliminar(funNombre);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioFunFuncion.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioFunFuncion.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     

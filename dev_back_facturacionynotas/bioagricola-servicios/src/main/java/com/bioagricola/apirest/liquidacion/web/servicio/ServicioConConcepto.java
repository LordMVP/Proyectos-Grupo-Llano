...
import com.bioagricola.apirest.liquidacion.negocio.NegocioConConcepto;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.IConConcepto;
import com.bioagricola.apirest.modelo.dtos.ConConceptoDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;

/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad ConConcepto
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/conconcepto")
public class ServicioConConcepto implements IConConcepto {

    @Autowired
    private NegocioConConcepto negocioConConcepto;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioConConcepto.class.getName());

    /**
     * Realiza un consulta en la entidad ConConcepto aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal conConceptoId>1&conConceptoName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: conConceptoId$ASC, conConceptoName$DESC
     ...
     * @return Una lista de DAOs de los ConConcepto que se consultaron con los parámetros enviados por el cliente
     ...
     */
    @GetMapping
    public List<ConConceptoDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioConConcepto.consultar(filterBy, orderBy, from, to);
        // protected region Use esta region para su implementacion end 
    }

    /**
     * Crea el conConcepto que se pasa como parámetro en la base de datos.
     * 
     * @param conConceptoDTO El DAO de la entidad ConConcepto a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return El identificador de la insntancia de ConConcepto recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public ConConceptoDTO crear(@RequestBody ConConceptoDTO conConceptoDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioConConcepto.crear(conConceptoDTO);
        // protected region Use esta region para su implementacion end 
        
    }

    /**
     * Actualiza en la base de datos el conConcepto que se pasa como parámetro.
     * 
     * @param conConceptoDTO El DAO de la entidad ConConcepto a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return El identificador de la instancia de la entidad ConConcepto que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public ConConceptoDTO actualizar(@RequestBody ConConceptoDTO conConceptoDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioConConcepto.actualizar(conConceptoDTO);
        // protected region Use esta region para su implementacion end
    }

    /**
     * Elimina el conConcepto con el identificador que se pasa como parámetro.
     * 
     * @param uniConcepto Valor del atributo del identificador de la instancia de la entidad  conConcepto a eliminar
     * @return El identificador del conConcepto que ha sido eliminado
     */
    @DeleteMapping
    public String eliminar(@RequestParam("uniConcepto") Integer uniConcepto) {
        // protected region Use esta region para su implementacion on begin

        return negocioConConcepto.eliminar(uniConcepto);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioConConcepto.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: conConceptoId$ASC, conConceptoName$DESC
     * @param atributo Nombre del atributo de la entidad ConConcepto del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioConConcepto.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     
    /*
    @PostMapping(value="/getConceptoInformacion",consumes = "application/json")
    public List<Object> getConceptoInformacion(@RequestBody ConConceptoDTO requestId) {
    	return negocioConConcepto.getConceptoInformacion(
    			requestId.getUniConcepto());
    	}

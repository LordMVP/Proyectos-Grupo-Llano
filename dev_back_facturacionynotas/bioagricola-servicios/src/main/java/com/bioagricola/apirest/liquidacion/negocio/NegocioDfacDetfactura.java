...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad DfacDetfactura
 * @author GeneradorCRUD
 */
@Service
public class NegocioDfacDetfactura  extends NegocioAbstracto<DfacDetfactura,DfacDetfacturaDTO> /*implements IDfacDetfactura*/ {
     ...
     */
    private static final Logger logger = Logger.getLogger(NegocioDfacDetfactura.class.getName());
    ...
    /**
     * Realiza un consulta en la entidad DfacDetfactura aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal dfacDetfacturaId>1&dfacDetfacturaName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: dfacDetfacturaId$ASC, dfacDetfacturaName$DESC
     ...
     * @return Una lista de DAOs de los DfacDetfactura que se consultaron con los parámetros enviados por el cliente
     ...
     */
    public List<DfacDetfacturaDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorDfacDetfactura.consultar(filtros, ordenamiento, rango));
        // protected region Modifique el metodo consultar end
    }

    /**
     * Crea el dfacDetfactura que se pasa como parámetro en la base de datos.
     * 
     * @param dfacDetfacturaDTO El DAO de la entidad DfacDetfactura a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return La insntancia de DfacDetfactura recién creado
     */
    public DfacDetfacturaDTO crear(DfacDetfacturaDTO dfacDetfacturaDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", dfacDetfacturaDTO);

        DfacDetfactura dfacDetfactura = new DfacDetfactura();
        copiarPropiedades(dfacDetfactura, dfacDetfacturaDTO);
        
        manejadorDfacDetfactura.save(dfacDetfactura);

        return dfacDetfacturaDTO;
        // protected region Modifique el metodo crear end
    }

    /**
     * Actualiza en la base de datos el dfacDetfactura que se pasa como parámetro.
     * 
     * @param dfacDetfacturaDTO El DAO de la entidad DfacDetfactura a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return La instancia de la entidad DfacDetfactura que ha sido actualizado
     */
    public DfacDetfacturaDTO actualizar(DfacDetfacturaDTO dfacDetfacturaDTO){
        ...
        logService(this.getClass().getName(), "actualizar", dfacDetfacturaDTO);

        DfacDetfactura dfacDetfactura = manejadorDfacDetfactura.getOne(dfacDetfacturaDTO.getDfacIderegistr());                
        copiarPropiedades(dfacDetfactura, dfacDetfacturaDTO);
    ...
    /**
     * Elimina el dfacDetfactura con el identificador que se pasa como parámetro.
     * 
     * @param dfacIderegistr Valor del atributo del identificador de la instancia de la entidad  dfacDetfactura a eliminar
     * @return El identificador del dfacDetfactura que ha sido eliminado
     */
    public String eliminar(Long dfacIderegistr) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", dfacIderegistr);
        manejadorDfacDetfactura.deleteById(dfacIderegistr);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(dfacIderegistr));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorDfacDetfactura.consultarTotalRegistros(filtros, 
                    rango));
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: dfacDetfacturaId$ASC, dfacDetfacturaName$DESC
     * @param atributo Nombre del atributo de la entidad DfacDetfactura del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorDfacDetfactura.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return DfacDetfactura.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected DfacDetfacturaDTO instanciarDAO() {
        return new DfacDetfacturaDTO();
    }       

 	public Object valorFactura(Integer idFactura) {
 		
		return manejadorDfacDetfactura.getValorFactura(idFactura);
	}

...
import com.bioagricola.apirest.liquidacion.negocio.NegocioDocDocumento;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.IDocDocumento;
...
/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad DocDocumento
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/docdocumento")
public class ServicioDocDocumento implements IDocDocumento {

    @Autowired
    private NegocioDocDocumento negocioDocDocumento;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioDocDocumento.class.getName());
     ...
     */
    @GetMapping
    public List<DocDocumentoDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioDocDocumento.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de DocDocumento recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public DocDocumentoDTO crear(@RequestBody DocDocumentoDTO docDocumentoDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioDocDocumento.crear(docDocumentoDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad DocDocumento que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public DocDocumentoDTO actualizar(@RequestBody DocDocumentoDTO docDocumentoDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioDocDocumento.actualizar(docDocumentoDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("uniDocumento") Integer uniDocumento) {
        // protected region Use esta region para su implementacion on begin

        return negocioDocDocumento.eliminar(uniDocumento);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioDocDocumento.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioDocDocumento.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     
    
    /**
     * Servicio de consulta de documentos según la empresa en sesión
     * */
    @GetMapping("/consultaDocumentos")
    public List<DocumentoDTO> consultaDocumentos() {   
        return negocioDocDocumento.consultaDocumentos(); 
    }
}

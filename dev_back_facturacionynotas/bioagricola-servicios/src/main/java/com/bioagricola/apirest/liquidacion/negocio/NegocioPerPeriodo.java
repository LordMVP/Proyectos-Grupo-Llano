...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad PerPeriodo
 *
 * @author GeneradorCRUD
 */
@Service
public class NegocioPerPeriodo extends NegocioAbstracto<PerPeriodo, PerPeriodoDTO> {
     ...
     */
    private static final Logger logger = Logger.getLogger(NegocioPerPeriodo.class.getName());
     ...
     */
    public List<PerPeriodoDTO> consultar(String filterBy,
        ...
        return convertirListaEntidadesADao(manejadorPerPeriodo.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de PerPeriodo recién creado
     */
    public PerPeriodoDTO crear(PerPeriodoDTO perPeriodoDTO) {
        // protected region Modifique el metodo crear on begin

        logService(this.getClass().getName(), "crear", perPeriodoDTO);

        PerPeriodo perPeriodo = new PerPeriodo();
        copiarPropiedades(perPeriodo, perPeriodoDTO);

        manejadorPerPeriodo.save(perPeriodo);

        return perPeriodoDTO;
     ...
     * @return La instancia de la entidad PerPeriodo que ha sido actualizado
     */
    public PerPeriodoDTO actualizar(PerPeriodoDTO perPeriodoDTO) {
        // protected region Modifique el metodo actualizar on begin

        logService(this.getClass().getName(), "actualizar", perPeriodoDTO);

        PerPeriodo perPeriodo = manejadorPerPeriodo.getOne(perPeriodoDTO.getPerIderegistro());
        copiarPropiedades(perPeriodo, perPeriodoDTO);
    ...
    public String eliminar(Integer perIderegistro) {
        ...
        logService(this.getClass().getName(), "eliminar", perIderegistro);
        manejadorPerPeriodo.deleteById(perIderegistro);


        StringBuilder valores = new StringBuilder();
        valores.append(String.valueOf(perIderegistro));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorPerPeriodo.consultarTotalRegistros(filtros,
                rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorPerPeriodo.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return PerPeriodo.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected PerPeriodoDTO instanciarDAO() {
        return new PerPeriodoDTO();
    }

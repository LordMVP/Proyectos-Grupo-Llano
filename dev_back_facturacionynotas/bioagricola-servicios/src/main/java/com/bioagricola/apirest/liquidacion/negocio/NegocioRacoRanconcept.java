...
import com.bioagricola.apirest.modelo.manejadores.ManejadorRacoRanconcept;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad RacoRanconcept
 * @author GeneradorCRUD
 */
@Service
public class NegocioRacoRanconcept extends NegocioAbstracto<RacoRanconcept,RacoRanconceptDTO> {

    @Autowired
    private ManejadorRacoRanconcept manejadorRacoRanconcept;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioRacoRanconcept.class.getName());
    ...
    /**
     * Realiza un consulta en la entidad RacoRanconcept aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal racoRanconceptId>1&racoRanconceptName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: racoRanconceptId$ASC, racoRanconceptName$DESC
     ...
     * @return Una lista de DAOs de los RacoRanconcept que se consultaron con los parámetros enviados por el cliente
     ...
     */
    public List<RacoRanconceptDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorRacoRanconcept.consultar(filtros, ordenamiento, rango));
        // protected region Modifique el metodo consultar end
    }

    /**
     * Crea el racoRanconcept que se pasa como parámetro en la base de datos.
     * 
     * @param racoRanconceptDTO El DAO de la entidad RacoRanconcept a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return La insntancia de RacoRanconcept recién creado
     */
    public RacoRanconceptDTO crear(RacoRanconceptDTO racoRanconceptDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", racoRanconceptDTO);

        RacoRanconcept racoRanconcept = new RacoRanconcept();
        copiarPropiedades(racoRanconcept, racoRanconceptDTO);
        
        manejadorRacoRanconcept.save(racoRanconcept);

        return racoRanconceptDTO;
        // protected region Modifique el metodo crear end
    }

    /**
     * Actualiza en la base de datos el racoRanconcept que se pasa como parámetro.
     * 
     * @param racoRanconceptDTO El DAO de la entidad RacoRanconcept a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return La instancia de la entidad RacoRanconcept que ha sido actualizado
     */
    public RacoRanconceptDTO actualizar(RacoRanconceptDTO racoRanconceptDTO){
        ...
        logService(this.getClass().getName(), "actualizar", racoRanconceptDTO);

        RacoRanconcept racoRanconcept = manejadorRacoRanconcept.getOne(racoRanconceptDTO.getRacoIderegistr());                
        copiarPropiedades(racoRanconcept, racoRanconceptDTO);
    ...
    /**
     * Elimina el racoRanconcept con el identificador que se pasa como parámetro.
     * 
     * @param racoIderegistr Valor del atributo del identificador de la instancia de la entidad  racoRanconcept a eliminar
     * @return El identificador del racoRanconcept que ha sido eliminado
     */
    public String eliminar(Integer racoIderegistr) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", racoIderegistr);
        manejadorRacoRanconcept.deleteById(racoIderegistr);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(racoIderegistr));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorRacoRanconcept.consultarTotalRegistros(filtros, 
                    rango));
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: racoRanconceptId$ASC, racoRanconceptName$DESC
     * @param atributo Nombre del atributo de la entidad RacoRanconcept del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorRacoRanconcept.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return RacoRanconcept.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected RacoRanconceptDTO instanciarDAO() {
        return new RacoRanconceptDTO();
    }       

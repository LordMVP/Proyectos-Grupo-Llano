...
import com.bioagricola.apirest.modelo.manejadores.ManejadorTidoTipdocumen;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad TidoTipdocumen
 * @author GeneradorCRUD
 */
@Service
public class NegocioTidoTipdocumen extends NegocioAbstracto<TidoTipdocumen,TidoTipdocumenDTO> {

    @Autowired
    private ManejadorTidoTipdocumen manejadorTidoTipdocumen;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioTidoTipdocumen.class.getName());
     ...
     */
    public List<TidoTipdocumenDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorTidoTipdocumen.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de TidoTipdocumen recién creado
     */
    public TidoTipdocumenDTO crear(TidoTipdocumenDTO tidoTipdocumenDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", tidoTipdocumenDTO);

        TidoTipdocumen tidoTipdocumen = new TidoTipdocumen();
        copiarPropiedades(tidoTipdocumen, tidoTipdocumenDTO);
        
        manejadorTidoTipdocumen.save(tidoTipdocumen);

        return tidoTipdocumenDTO;
     ...
     * @return La instancia de la entidad TidoTipdocumen que ha sido actualizado
     */
    public TidoTipdocumenDTO actualizar(TidoTipdocumenDTO tidoTipdocumenDTO){
        ...
        logService(this.getClass().getName(), "actualizar", tidoTipdocumenDTO);

        TidoTipdocumen tidoTipdocumen = manejadorTidoTipdocumen.getOne(tidoTipdocumenDTO.getUniTipdocument());                
        copiarPropiedades(tidoTipdocumen, tidoTipdocumenDTO);
    ...
    public String eliminar(Integer uniTipdocument) {
        ...
        logService(this.getClass().getName(), "eliminar", uniTipdocument);
        manejadorTidoTipdocumen.deleteById(uniTipdocument);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(uniTipdocument));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorTidoTipdocumen.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorTidoTipdocumen.consultarLista(filtros, ordenamiento, infoAgrupamiento));
     ...
     * el servicio de consutla de tipos de documento
     * */
    public List<TipoDocumentoDTO> consultaTiposDocumento(Integer uniDocumento) {
		
    	//Obtención del Id de la empresa en sesión como parámetro de la consulta
    	int idEmpresa = JwtUtil.auditoriaDTO.getIdEmpresa();
    	List<Object[]> listaEntidadTipoDocumento = manejadorTidoTipdocumen.consultaTiposDocumento(uniDocumento, idEmpresa);
    	...
    	if (!listaEntidadTipoDocumento.isEmpty()) {			
    		for (Object[] row : listaEntidadTipoDocumento) {
    			TipoDocumentoDTO documento = new TipoDocumentoDTO();
    			documento.setUniTipDocument((Integer)row[0]);
    			documento.setUniNombre1((String)row[1]);
    			listaTipoDocumentoDTO.add(documento);
    		}
		}
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return TidoTipdocumen.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected TidoTipdocumenDTO instanciarDAO() {
        return new TidoTipdocumenDTO();
    }     

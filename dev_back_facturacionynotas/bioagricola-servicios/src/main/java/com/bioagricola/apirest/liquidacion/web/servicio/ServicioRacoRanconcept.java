...
import com.bioagricola.apirest.liquidacion.negocio.NegocioRacoRanconcept;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.IRacoRanconcept;
import com.bioagricola.apirest.modelo.dtos.RacoRanconceptDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;

/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad RacoRanconcept
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/racoranconcept")
public class ServicioRacoRanconcept implements IRacoRanconcept {

    @Autowired
    private NegocioRacoRanconcept negocioRacoRanconcept;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioRacoRanconcept.class.getName());
     ...
     */
    @GetMapping
    public List<RacoRanconceptDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioRacoRanconcept.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de RacoRanconcept recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public RacoRanconceptDTO crear(@RequestBody RacoRanconceptDTO racoRanconceptDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioRacoRanconcept.crear(racoRanconceptDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad RacoRanconcept que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public RacoRanconceptDTO actualizar(@RequestBody RacoRanconceptDTO racoRanconceptDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioRacoRanconcept.actualizar(racoRanconceptDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("racoIderegistr") Integer racoIderegistr) {
        // protected region Use esta region para su implementacion on begin

        return negocioRacoRanconcept.eliminar(racoIderegistr);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioRacoRanconcept.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioRacoRanconcept.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     

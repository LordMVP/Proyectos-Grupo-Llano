...
import com.bioagricola.apirest.modelo.manejadores.ManejadorLiusLiquso;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad LiusLiquso
 * @author GeneradorCRUD
 */
@Service
public class NegocioLiusLiquso extends NegocioAbstracto<LiusLiquso,LiusLiqusoDTO> {

    @Autowired
    private ManejadorLiusLiquso manejadorLiusLiquso;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioLiusLiquso.class.getName());
     ...
     */
    public List<LiusLiqusoDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorLiusLiquso.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de LiusLiquso recién creado
     */
    public LiusLiqusoDTO crear(LiusLiqusoDTO liusLiqusoDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", liusLiqusoDTO);

        LiusLiquso liusLiquso = new LiusLiquso();
        copiarPropiedades(liusLiquso, liusLiqusoDTO);
        
        manejadorLiusLiquso.save(liusLiquso);

        return liusLiqusoDTO;
     ...
     * @return La instancia de la entidad LiusLiquso que ha sido actualizado
     */
    public LiusLiqusoDTO actualizar(LiusLiqusoDTO liusLiqusoDTO){
        // protected region Modifique el metodo actualizar on begin
    
        logService(this.getClass().getName(), "actualizar", liusLiqusoDTO);

        LiusLiquso liusLiquso = manejadorLiusLiquso.getOne(liusLiqusoDTO.getLiusIderegistr());                
        copiarPropiedades(liusLiquso, liusLiqusoDTO);
    ...
    public String eliminar(Integer liusIderegistr) {
        ...
        logService(this.getClass().getName(), "eliminar", liusIderegistr);
        manejadorLiusLiquso.deleteById(liusIderegistr);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(liusIderegistr));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorLiusLiquso.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorLiusLiquso.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return LiusLiquso.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected LiusLiqusoDTO instanciarDAO() {
        return new LiusLiqusoDTO();
    }       

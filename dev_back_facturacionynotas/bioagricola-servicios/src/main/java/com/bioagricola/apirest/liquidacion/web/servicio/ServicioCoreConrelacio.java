...
import com.bioagricola.apirest.liquidacion.negocio.NegocioCoreConrelacio;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.ICoreConrelacio;
import com.bioagricola.apirest.modelo.dtos.CoreConrelacioDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;


/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad CoreConrelacio
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/coreconrelacio")
public class ServicioCoreConrelacio implements ICoreConrelacio {

    @Autowired
    private NegocioCoreConrelacio negocioCoreConrelacio;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioCoreConrelacio.class.getName());
     ...
     */
    @GetMapping
    public List<CoreConrelacioDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioCoreConrelacio.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de CoreConrelacio recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public CoreConrelacioDTO crear(@RequestBody CoreConrelacioDTO coreConrelacioDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioCoreConrelacio.crear(coreConrelacioDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad CoreConrelacio que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public CoreConrelacioDTO actualizar(@RequestBody CoreConrelacioDTO coreConrelacioDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioCoreConrelacio.actualizar(coreConrelacioDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("coreIderegistr") Integer coreIderegistr) {
        // protected region Use esta region para su implementacion on begin

        return negocioCoreConrelacio.eliminar(coreIderegistr);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioCoreConrelacio.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioCoreConrelacio.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     

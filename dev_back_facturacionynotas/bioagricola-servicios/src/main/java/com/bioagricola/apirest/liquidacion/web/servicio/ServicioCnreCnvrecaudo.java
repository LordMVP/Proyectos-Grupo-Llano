...
import com.bioagricola.apirest.liquidacion.negocio.NegocioCnreCnvrecaudo;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.ICnreCnvrecaudo;
import com.bioagricola.apirest.modelo.dtos.CnreCnvrecaudoDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;


/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad CnreCnvrecaudo
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/cnrecnvrecaudo")
public class ServicioCnreCnvrecaudo implements ICnreCnvrecaudo {

    @Autowired
    private NegocioCnreCnvrecaudo negocioCnreCnvrecaudo;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioCnreCnvrecaudo.class.getName());
     ...
     */
    @GetMapping
    public List<CnreCnvrecaudoDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioCnreCnvrecaudo.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de CnreCnvrecaudo recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public CnreCnvrecaudoDTO crear(@RequestBody CnreCnvrecaudoDTO cnreCnvrecaudoDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioCnreCnvrecaudo.crear(cnreCnvrecaudoDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad CnreCnvrecaudo que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public CnreCnvrecaudoDTO actualizar(@RequestBody CnreCnvrecaudoDTO cnreCnvrecaudoDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioCnreCnvrecaudo.actualizar(cnreCnvrecaudoDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("cnreIderegistr") Integer cnreIderegistr) {
        // protected region Use esta region para su implementacion on begin

        return negocioCnreCnvrecaudo.eliminar(cnreIderegistr);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioCnreCnvrecaudo.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioCnreCnvrecaudo.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     

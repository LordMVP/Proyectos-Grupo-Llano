...
import com.bioagricola.apirest.modelo.manejadores.ManejadorSusSuscripcion;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad SusSuscripcion
 *
 * @author GeneradorCRUD
 */
@Service
public class NegocioSusSuscripcion extends NegocioAbstracto<SusSuscripcion, SusSuscripcionDTO> {

    @Autowired
    private ManejadorSusSuscripcion manejadorSusSuscripcion;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioSusSuscripcion.class.getName());
     ...
     */
    public List<SusSuscripcionDTO> consultar(String filterBy,
        ...
        return convertirListaEntidadesADao(manejadorSusSuscripcion.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de SusSuscripcion recién creado
     */
    public SusSuscripcionDTO crear(SusSuscripcionDTO susSuscripcionDTO) {
        // protected region Modifique el metodo crear on begin

        logService(this.getClass().getName(), "crear", susSuscripcionDTO);

        SusSuscripcion susSuscripcion = new SusSuscripcion();
        copiarPropiedades(susSuscripcion, susSuscripcionDTO);

        manejadorSusSuscripcion.save(susSuscripcion);

        return susSuscripcionDTO;
     ...
     * @return La instancia de la entidad SusSuscripcion que ha sido actualizado
     */
    public SusSuscripcionDTO actualizar(SusSuscripcionDTO susSuscripcionDTO) {
        ...
        logService(this.getClass().getName(), "actualizar", susSuscripcionDTO);

        SusSuscripcion susSuscripcion = manejadorSusSuscripcion.getOne(susSuscripcionDTO.getSusIderegistro());
        copiarPropiedades(susSuscripcion, susSuscripcionDTO);
    ...
    public String eliminar(Long susIderegistro) {
        ...
        logService(this.getClass().getName(), "eliminar", susIderegistro);
        manejadorSusSuscripcion.deleteById(susIderegistro);


        StringBuilder valores = new StringBuilder();
        valores.append(String.valueOf(susIderegistro));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorSusSuscripcion.consultarTotalRegistros(filtros,
                rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorSusSuscripcion.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return SusSuscripcion.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected SusSuscripcionDTO instanciarDAO() {
        return new SusSuscripcionDTO();
    }

...
import com.bioagricola.apirest.modelo.manejadores.ManejadorUniUnidad;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad UniUnidad
 * @author GeneradorCRUD
 */
@Service
public class NegocioUniUnidad extends NegocioAbstracto<UniUnidad,UniUnidadDTO> {

    @Autowired
    private ManejadorUniUnidad manejadorUniUnidad;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioUniUnidad.class.getName());
    ...
    /**
     * Realiza un consulta en la entidad UniUnidad aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal uniUnidadId>1&uniUnidadName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: uniUnidadId$ASC, uniUnidadName$DESC
     ...
     * @return Una lista de DAOs de los UniUnidad que se consultaron con los parámetros enviados por el cliente
     ...
     */
    public List<UniUnidadDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorUniUnidad.consultar(filtros, ordenamiento, rango));
        // protected region Modifique el metodo consultar end
    }

    /**
     * Crea el uniUnidad que se pasa como parámetro en la base de datos.
     * 
     * @param uniUnidadDTO El DAO de la entidad UniUnidad a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return La insntancia de UniUnidad recién creado
     */
    public UniUnidadDTO crear(UniUnidadDTO uniUnidadDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", uniUnidadDTO);

        UniUnidad uniUnidad = new UniUnidad();
        copiarPropiedades(uniUnidad, uniUnidadDTO);
        
        manejadorUniUnidad.save(uniUnidad);
    ...
    /**
     * Actualiza en la base de datos el uniUnidad que se pasa como parámetro.
     * 
     * @param uniUnidadDTO El DAO de la entidad UniUnidad a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return La instancia de la entidad UniUnidad que ha sido actualizado
     */
    public UniUnidadDTO actualizar(UniUnidadDTO uniUnidadDTO){
        // protected region Modifique el metodo actualizar on begin
    
        logService(this.getClass().getName(), "actualizar", uniUnidadDTO);

        UniUnidad uniUnidad = manejadorUniUnidad.getOne(uniUnidadDTO.getUniIderegistro());                
        copiarPropiedades(uniUnidad, uniUnidadDTO);
    ...
    /**
     * Elimina el uniUnidad con el identificador que se pasa como parámetro.
     * 
     * @param uniIderegistro Valor del atributo del identificador de la instancia de la entidad  uniUnidad a eliminar
     * @return El identificador del uniUnidad que ha sido eliminado
     */
    public String eliminar(Integer uniIderegistro) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", uniIderegistro);
        manejadorUniUnidad.deleteById(uniIderegistro);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(uniIderegistro));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorUniUnidad.consultarTotalRegistros(filtros, 
                    rango));
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: uniUnidadId$ASC, uniUnidadName$DESC
     * @param atributo Nombre del atributo de la entidad UniUnidad del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorUniUnidad.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return UniUnidad.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected UniUnidadDTO instanciarDAO() {
        return new UniUnidadDTO();
    }       

...
import com.bioagricola.apirest.liquidacion.negocio.NegocioCicCiclo;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.ICicCiclo;
import com.bioagricola.apirest.modelo.dtos.CicCicloDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;


/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad CicCiclo
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/cicciclo")
public class ServicioCicCiclo implements ICicCiclo {

    @Autowired
    private NegocioCicCiclo negocioCicCiclo;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioCicCiclo.class.getName());
     ...
     */
    @GetMapping
    public List<CicCicloDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioCicCiclo.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de CicCiclo recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public CicCicloDTO crear(@RequestBody CicCicloDTO cicCicloDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioCicCiclo.crear(cicCicloDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad CicCiclo que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public CicCicloDTO actualizar(@RequestBody CicCicloDTO cicCicloDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioCicCiclo.actualizar(cicCicloDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("cicIderegistro") Integer cicIderegistro) {
        // protected region Use esta region para su implementacion on begin

        return negocioCicCiclo.eliminar(cicIderegistro);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioCicCiclo.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioCicCiclo.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }
    
    /**
     * Método encargado de cargar los ciclos correspondientes a la empresa en sesión
     * la empresa en sesión se obtiene tras la validación del token y se envía como parámetro
     * en NegocioCicCiclo.java
     * */
    @GetMapping("/consultaCiclos")
    public List<CicCicloDTO> consultaCiclos() 
            throws InvalidParameterException {
        
        return negocioCicCiclo.consultarCiclos(); 
    }

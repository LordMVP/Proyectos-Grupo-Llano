...
import com.bioagricola.apirest.modelo.manejadores.ManejadorCoreConrelacio;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad CoreConrelacio
 * @author GeneradorCRUD
 */
@Service
public class NegocioCoreConrelacio extends NegocioAbstracto<CoreConrelacio,CoreConrelacioDTO> {

    @Autowired
    private ManejadorCoreConrelacio manejadorCoreConrelacio;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioCoreConrelacio.class.getName());
    ...
    /**
     * Realiza un consulta en la entidad CoreConrelacio aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal coreConrelacioId>1&coreConrelacioName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: coreConrelacioId$ASC, coreConrelacioName$DESC
     ...
     * @return Una lista de DAOs de los CoreConrelacio que se consultaron con los parámetros enviados por el cliente
     ...
     */
    public List<CoreConrelacioDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorCoreConrelacio.consultar(filtros, ordenamiento, rango));
        // protected region Modifique el metodo consultar end
    }

    /**
     * Crea el coreConrelacio que se pasa como parámetro en la base de datos.
     * 
     * @param coreConrelacioDTO El DAO de la entidad CoreConrelacio a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return La insntancia de CoreConrelacio recién creado
     */
    public CoreConrelacioDTO crear(CoreConrelacioDTO coreConrelacioDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", coreConrelacioDTO);

        CoreConrelacio coreConrelacio = new CoreConrelacio();
        copiarPropiedades(coreConrelacio, coreConrelacioDTO);
        
        manejadorCoreConrelacio.save(coreConrelacio);

        return coreConrelacioDTO;
        // protected region Modifique el metodo crear end
    }

    /**
     * Actualiza en la base de datos el coreConrelacio que se pasa como parámetro.
     * 
     * @param coreConrelacioDTO El DAO de la entidad CoreConrelacio a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return La instancia de la entidad CoreConrelacio que ha sido actualizado
     */
    public CoreConrelacioDTO actualizar(CoreConrelacioDTO coreConrelacioDTO){
        ...
        logService(this.getClass().getName(), "actualizar", coreConrelacioDTO);

        CoreConrelacio coreConrelacio = manejadorCoreConrelacio.getOne(coreConrelacioDTO.getCoreIderegistr());                
        copiarPropiedades(coreConrelacio, coreConrelacioDTO);
    ...
    /**
     * Elimina el coreConrelacio con el identificador que se pasa como parámetro.
     * 
     * @param coreIderegistr Valor del atributo del identificador de la instancia de la entidad  coreConrelacio a eliminar
     * @return El identificador del coreConrelacio que ha sido eliminado
     */
    public String eliminar(Integer coreIderegistr) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", coreIderegistr);
        manejadorCoreConrelacio.deleteById(coreIderegistr);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(coreIderegistr));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorCoreConrelacio.consultarTotalRegistros(filtros, 
                    rango));
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: coreConrelacioId$ASC, coreConrelacioName$DESC
     * @param atributo Nombre del atributo de la entidad CoreConrelacio del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorCoreConrelacio.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return CoreConrelacio.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected CoreConrelacioDTO instanciarDAO() {
        return new CoreConrelacioDTO();
    }       

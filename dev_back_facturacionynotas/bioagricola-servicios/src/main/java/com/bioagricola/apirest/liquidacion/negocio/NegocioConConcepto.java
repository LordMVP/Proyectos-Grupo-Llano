...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad ConConcepto
 * @author GeneradorCRUD
 */
@Service
public class NegocioConConcepto extends NegocioAbstracto<ConConcepto,ConConceptoDTO> {
     ...
     */
    private static final Logger logger = Logger.getLogger(NegocioConConcepto.class.getName());
     ...
     */
    public List<ConConceptoDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorConConcepto.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de ConConcepto recién creado
     */
    public ConConceptoDTO crear(ConConceptoDTO conConceptoDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", conConceptoDTO);

        ConConcepto conConcepto = new ConConcepto();
        copiarPropiedades(conConcepto, conConceptoDTO);
        
        manejadorConConcepto.save(conConcepto);

        return conConceptoDTO;
     ...
     * @return La instancia de la entidad ConConcepto que ha sido actualizado
     */
    public ConConceptoDTO actualizar(ConConceptoDTO conConceptoDTO){
        // protected region Modifique el metodo actualizar on begin
    
        logService(this.getClass().getName(), "actualizar", conConceptoDTO);

        ConConcepto conConcepto = manejadorConConcepto.getOne(conConceptoDTO.getUniConcepto());                
        copiarPropiedades(conConcepto, conConceptoDTO);
    ...
    public String eliminar(Integer uniConcepto) {
        ...
        logService(this.getClass().getName(), "eliminar", uniConcepto);
        manejadorConConcepto.deleteById(uniConcepto);
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorConConcepto.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorConConcepto.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return ConConcepto.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected ConConceptoDTO instanciarDAO() {
        return new ConConceptoDTO();
    }       
    ...
    public Integer valorConceptoRelacionado(List<Object> valor2) {

          
    	for (Object item : valor2) {
    	    Object[] fields = (Object[]) item;
    	    BigDecimal valor = (BigDecimal) fields[6];

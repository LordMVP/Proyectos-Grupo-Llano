...
import com.bioagricola.apirest.liquidacion.negocio.NegocioDfacDetfactura;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.IDfacDetfactura;
import com.bioagricola.apirest.modelo.dtos.DfacDetfacturaDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;

/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad DfacDetfactura
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/dfacdetfactura")
public class ServicioDfacDetfactura implements IDfacDetfactura {

    @Autowired
    private NegocioDfacDetfactura negocioDfacDetfactura;
     ...
     */
    @GetMapping
    public List<DfacDetfacturaDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioDfacDetfactura.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de DfacDetfactura recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public DfacDetfacturaDTO crear(@RequestBody DfacDetfacturaDTO dfacDetfacturaDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioDfacDetfactura.crear(dfacDetfacturaDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad DfacDetfactura que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public DfacDetfacturaDTO actualizar(@RequestBody DfacDetfacturaDTO dfacDetfacturaDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioDfacDetfactura.actualizar(dfacDetfacturaDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("dfacIderegistr") Long dfacIderegistr) {
        // protected region Use esta region para su implementacion on begin

        return negocioDfacDetfactura.eliminar(dfacIderegistr);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioDfacDetfactura.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioDfacDetfactura.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     
    
    // protected region Use esta region para su implementacion de otros servicios on begin
    @GetMapping("/prueba")
    public Object ValorFactura(@RequestParam(value="idFactura") Integer idFactura) {
    	System.out.println("fdff");
    	return negocioDfacDetfactura.valorFactura(idFactura);

...
import com.bioagricola.apirest.liquidacion.negocio.NegocioDrecDetrecaudo;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.IDrecDetrecaudo;
import com.bioagricola.apirest.modelo.dtos.DrecDetrecaudoDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;

/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad DrecDetrecaudo
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/drecdetrecaudo")
public class ServicioDrecDetrecaudo implements IDrecDetrecaudo {

    @Autowired
    private NegocioDrecDetrecaudo negocioDrecDetrecaudo;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioDrecDetrecaudo.class.getName());
     ...
     */
    @GetMapping
    public List<DrecDetrecaudoDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioDrecDetrecaudo.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de DrecDetrecaudo recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public DrecDetrecaudoDTO crear(@RequestBody DrecDetrecaudoDTO drecDetrecaudoDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioDrecDetrecaudo.crear(drecDetrecaudoDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad DrecDetrecaudo que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public DrecDetrecaudoDTO actualizar(@RequestBody DrecDetrecaudoDTO drecDetrecaudoDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioDrecDetrecaudo.actualizar(drecDetrecaudoDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("drecIderegistr") Long drecIderegistr) {
        // protected region Use esta region para su implementacion on begin

        return negocioDrecDetrecaudo.eliminar(drecIderegistr);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioDrecDetrecaudo.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioDrecDetrecaudo.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     

...
import com.bioagricola.apirest.liquidacion.negocio.NegocioLiesLiqespecial;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.ILiesLiqespecial;
import com.bioagricola.apirest.modelo.dtos.LiesLiqespecialDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;

/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad LiesLiqespecial
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/liesliqespecial")
public class ServicioLiesLiqespecial implements ILiesLiqespecial {

    @Autowired
    private NegocioLiesLiqespecial negocioLiesLiqespecial;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioLiesLiqespecial.class.getName());
     ...
     */
    @GetMapping
    public List<LiesLiqespecialDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioLiesLiqespecial.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de LiesLiqespecial recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public LiesLiqespecialDTO crear(@RequestBody LiesLiqespecialDTO liesLiqespecialDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioLiesLiqespecial.crear(liesLiqespecialDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad LiesLiqespecial que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public LiesLiqespecialDTO actualizar(@RequestBody LiesLiqespecialDTO liesLiqespecialDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioLiesLiqespecial.actualizar(liesLiqespecialDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("liesIderegistr") Long liesIderegistr) {
        // protected region Use esta region para su implementacion on begin

        return negocioLiesLiqespecial.eliminar(liesIderegistr);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioLiesLiqespecial.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioLiesLiqespecial.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     

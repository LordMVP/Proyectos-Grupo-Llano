...
import com.bioagricola.apirest.modelo.manejadores.ManejadorClteClatercero;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad ClteClatercero
 * @author GeneradorCRUD
 */
@Service
public class NegocioClteClatercero extends NegocioAbstracto<ClteClatercero,ClteClaterceroDTO> {

    @Autowired
    private ManejadorClteClatercero manejadorClteClatercero;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioClteClatercero.class.getName());
     ...
     */
    public List<ClteClaterceroDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorClteClatercero.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de ClteClatercero recién creado
     */
    public ClteClaterceroDTO crear(ClteClaterceroDTO clteClaterceroDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", clteClaterceroDTO);

        ClteClatercero clteClatercero = new ClteClatercero();
        copiarPropiedades(clteClatercero, clteClaterceroDTO);
        
        manejadorClteClatercero.save(clteClatercero);

        return clteClaterceroDTO;
     ...
     * @return La instancia de la entidad ClteClatercero que ha sido actualizado
     */
    public ClteClaterceroDTO actualizar(ClteClaterceroDTO clteClaterceroDTO){
        ...
        logService(this.getClass().getName(), "actualizar", clteClaterceroDTO);

        ClteClatercero clteClatercero = manejadorClteClatercero.getOne(clteClaterceroDTO.getClteIderegistr());                
        copiarPropiedades(clteClatercero, clteClaterceroDTO);
    ...
    public String eliminar(Long clteIderegistr) {
        ...
        logService(this.getClass().getName(), "eliminar", clteIderegistr);
        manejadorClteClatercero.deleteById(clteIderegistr);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(clteIderegistr));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorClteClatercero.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorClteClatercero.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return ClteClatercero.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected ClteClaterceroDTO instanciarDAO() {
        return new ClteClaterceroDTO();
    }       

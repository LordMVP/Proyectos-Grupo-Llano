...
import com.bioagricola.apirest.liquidacion.negocio.NegocioEmpresas;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.IEmpresas;
...
/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad Empresas
 * 
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/empresas")
public class ServicioEmpresas implements IEmpresas {

	@Autowired
	private NegocioEmpresas negocioEmpresas;

	/**
	 * Variable estatica para imprimir logs...
	 */
	private static final Logger logger = Logger.getLogger(ServicioEmpresas.class.getName());
	 ...
	 */
	@GetMapping
	public List<EmpresasDTO> consultar(@RequestParam(value = "filterBy") String filterBy,
		...
		return negocioEmpresas.consultar(filterBy, orderBy, from, to);
	 ...
	 * @return El identificador de la insntancia de Empresas recién creado
	 */
	@PostMapping(consumes = "application/json", produces = "application/json")
	public EmpresasDTO crear(@RequestBody EmpresasDTO empresasDTO) {
		// protected region Use esta region para su implementacion on begin

		return negocioEmpresas.crear(empresasDTO);
		// protected region Use esta region para su implementacion end
	 ...
	 * @return El identificador de la instancia de la entidad Empresas que ha sido
	 *         actualizado
	 */
	@PutMapping(consumes = "application/json", produces = "application/json")
	public EmpresasDTO actualizar(@RequestBody EmpresasDTO empresasDTO) {
		// protected region Use esta region para su implementacion on begin

		return negocioEmpresas.actualizar(empresasDTO);
		// protected region Use esta region para su implementacion end
	}
	 ...
	 */
	@DeleteMapping
	public String eliminar(@RequestParam("empresaCod") String empresaCod) {
		// protected region Use esta region para su implementacion on begin

		return negocioEmpresas.eliminar(empresaCod);
		// protected region Use esta region para su implementacion end
	}
	...
	public String contar(@RequestParam(value = "filterBy") String filterBy, @RequestParam(value = "from") Integer from,
		...
		return negocioEmpresas.contar(filterBy, from, to);
		// protected region Use esta region para su implementacion end
	}
	...
	public List<String> consultarLista(@RequestParam(value = "filterBy") String filterBy,
		...
		// protected region Use esta region para su implementacion on begin
		return negocioEmpresas.consultarLista(filterBy, orderBy, atributo);
		// protected region Use esta region para su implementacion end
	}
	...
	// Consultar lista homologada con empresas de la facturacion conjunta

	@GetMapping("/listaHomologada")
	public List<EmpresasHomologadasDTO> consultar() {
		return negocioEmpresas.consultaEmpresasHomologadas();
	}

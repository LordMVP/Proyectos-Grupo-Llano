...
import com.bioagricola.apirest.modelo.manejadores.ManejadorLiqLiquidacion;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad LiqLiquidacion
 * @author GeneradorCRUD
 */
@Service
public class NegocioLiqLiquidacion extends NegocioAbstracto<LiqLiquidacion,LiqLiquidacionDTO> {
     ...
     */
    private static final Logger logger = Logger.getLogger(NegocioLiqLiquidacion.class.getName());
     ...
     */
    public List<LiqLiquidacionDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorLiqLiquidacion.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de LiqLiquidacion recién creado
     */
    public LiqLiquidacionDTO crear(LiqLiquidacionDTO liqLiquidacionDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", liqLiquidacionDTO);

        LiqLiquidacion liqLiquidacion = new LiqLiquidacion();
        copiarPropiedades(liqLiquidacion, liqLiquidacionDTO);
        
        manejadorLiqLiquidacion.save(liqLiquidacion);

        return liqLiquidacionDTO;
     ...
     * @return La instancia de la entidad LiqLiquidacion que ha sido actualizado
     */
    public LiqLiquidacionDTO actualizar(LiqLiquidacionDTO liqLiquidacionDTO){
        ...
        logService(this.getClass().getName(), "actualizar", liqLiquidacionDTO);

        LiqLiquidacion liqLiquidacion = manejadorLiqLiquidacion.getOne(liqLiquidacionDTO.getUniLiquidacion());                
        copiarPropiedades(liqLiquidacion, liqLiquidacionDTO);
    ...
    public String eliminar(Integer uniLiquidacion) {
        ...
        logService(this.getClass().getName(), "eliminar", uniLiquidacion);
        manejadorLiqLiquidacion.deleteById(uniLiquidacion);
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorLiqLiquidacion.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorLiqLiquidacion.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return LiqLiquidacion.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected LiqLiquidacionDTO instanciarDAO() {
        return new LiqLiquidacionDTO();
    }       

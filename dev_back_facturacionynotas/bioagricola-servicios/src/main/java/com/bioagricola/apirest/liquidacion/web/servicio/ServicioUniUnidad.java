...
import com.bioagricola.apirest.liquidacion.negocio.NegocioUniUnidad;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.IUniUnidad;
import com.bioagricola.apirest.modelo.dtos.UniUnidadDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;

/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad UniUnidad
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/uniunidad")
public class ServicioUniUnidad implements IUniUnidad {

    @Autowired
    private NegocioUniUnidad negocioUniUnidad;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioUniUnidad.class.getName());
     ...
     */
    @GetMapping
    public List<UniUnidadDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioUniUnidad.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de UniUnidad recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public UniUnidadDTO crear(@RequestBody UniUnidadDTO uniUnidadDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioUniUnidad.crear(uniUnidadDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad UniUnidad que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public UniUnidadDTO actualizar(@RequestBody UniUnidadDTO uniUnidadDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioUniUnidad.actualizar(uniUnidadDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("uniIderegistro") Integer uniIderegistro) {
        // protected region Use esta region para su implementacion on begin

        return negocioUniUnidad.eliminar(uniIderegistro);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioUniUnidad.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioUniUnidad.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     

...
import com.bioagricola.apirest.liquidacion.negocio.NegocioLiagLiqagenda;
import com.bioagricola.apirest.liquidacion.negocio.interfaces.ILiagLiqagenda;
import com.bioagricola.apirest.modelo.dtos.LiagLiqagendaDTO;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;


/**
 * Servicios REST para operaciones CRUD y de negocio sobre la entidad LiagLiqagenda
 * @author GeneradorCRUD
 */
@RestController
@RequestMapping("/webresources/servicios/liagliqagenda")
public class ServicioLiagLiqagenda implements ILiagLiqagenda {

    @Autowired
    private NegocioLiagLiqagenda negocioLiagLiqagenda;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(ServicioLiagLiqagenda.class.getName());
     ...
     */
    @GetMapping
    public List<LiagLiqagendaDTO> consultar(@RequestParam(value="filterBy") String filterBy, 
        ...
        return negocioLiagLiqagenda.consultar(filterBy, orderBy, from, to);
     ...
     * @return El identificador de la insntancia de LiagLiqagenda recién creado
     */
    @PostMapping(consumes = "application/json", produces = "application/json")
    public LiagLiqagendaDTO crear(@RequestBody LiagLiqagendaDTO liagLiqagendaDTO) {
        // protected region Use esta region para su implementacion on begin

        return negocioLiagLiqagenda.crear(liagLiqagendaDTO);
        // protected region Use esta region para su implementacion end 
     ...
     * @return El identificador de la instancia de la entidad LiagLiqagenda que ha sido actualizado
     */
    @PutMapping(consumes = "application/json", produces = "application/json")
    public LiagLiqagendaDTO actualizar(@RequestBody LiagLiqagendaDTO liagLiqagendaDTO){
        // protected region Use esta region para su implementacion on begin

        return negocioLiagLiqagenda.actualizar(liagLiqagendaDTO);
        // protected region Use esta region para su implementacion end
    }
     ...
     */
    @DeleteMapping
    public String eliminar(@RequestParam("liagIderegistr") Integer liagIderegistr) {
        // protected region Use esta region para su implementacion on begin

        return negocioLiagLiqagenda.eliminar(liagIderegistr);
        // protected region Use esta region para su implementacion end
    }
    ...
    public String contar(@RequestParam(value="filterBy") String filterBy,
        ...
        return negocioLiagLiqagenda.contar(filterBy, from, to);
        // protected region Use esta region para su implementacion end
    }    
    ...
    public List<String> consultarLista(@RequestParam(value="filterBy") String filterBy,
        ...
        // protected region Use esta region para su implementacion on begin
        return negocioLiagLiqagenda.consultarLista(filterBy, orderBy, atributo);
        // protected region Use esta region para su implementacion end
    }     

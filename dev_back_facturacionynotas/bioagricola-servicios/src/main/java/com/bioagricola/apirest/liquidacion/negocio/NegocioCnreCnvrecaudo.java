...
import com.bioagricola.apirest.modelo.manejadores.ManejadorCnreCnvrecaudo;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad CnreCnvrecaudo
 * @author GeneradorCRUD
 */
@Service
public class NegocioCnreCnvrecaudo extends NegocioAbstracto<CnreCnvrecaudo,CnreCnvrecaudoDTO> {

    @Autowired
    private ManejadorCnreCnvrecaudo manejadorCnreCnvrecaudo;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioCnreCnvrecaudo.class.getName());
    ...
    /**
     * Realiza un consulta en la entidad CnreCnvrecaudo aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal cnreCnvrecaudoId>1&cnreCnvrecaudoName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: cnreCnvrecaudoId$ASC, cnreCnvrecaudoName$DESC
     ...
     * @return Una lista de DAOs de los CnreCnvrecaudo que se consultaron con los parámetros enviados por el cliente
     ...
     */
    public List<CnreCnvrecaudoDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorCnreCnvrecaudo.consultar(filtros, ordenamiento, rango));
        // protected region Modifique el metodo consultar end
    }

    /**
     * Crea el cnreCnvrecaudo que se pasa como parámetro en la base de datos.
     * 
     * @param cnreCnvrecaudoDTO El DAO de la entidad CnreCnvrecaudo a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return La insntancia de CnreCnvrecaudo recién creado
     */
    public CnreCnvrecaudoDTO crear(CnreCnvrecaudoDTO cnreCnvrecaudoDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", cnreCnvrecaudoDTO);

        CnreCnvrecaudo cnreCnvrecaudo = new CnreCnvrecaudo();
        copiarPropiedades(cnreCnvrecaudo, cnreCnvrecaudoDTO);
        
        manejadorCnreCnvrecaudo.save(cnreCnvrecaudo);

        return cnreCnvrecaudoDTO;
        // protected region Modifique el metodo crear end
    }

    /**
     * Actualiza en la base de datos el cnreCnvrecaudo que se pasa como parámetro.
     * 
     * @param cnreCnvrecaudoDTO El DAO de la entidad CnreCnvrecaudo a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return La instancia de la entidad CnreCnvrecaudo que ha sido actualizado
     */
    public CnreCnvrecaudoDTO actualizar(CnreCnvrecaudoDTO cnreCnvrecaudoDTO){
        ...
        logService(this.getClass().getName(), "actualizar", cnreCnvrecaudoDTO);

        CnreCnvrecaudo cnreCnvrecaudo = manejadorCnreCnvrecaudo.getOne(cnreCnvrecaudoDTO.getCnreIderegistr());                
        copiarPropiedades(cnreCnvrecaudo, cnreCnvrecaudoDTO);
    ...
    /**
     * Elimina el cnreCnvrecaudo con el identificador que se pasa como parámetro.
     * 
     * @param cnreIderegistr Valor del atributo del identificador de la instancia de la entidad  cnreCnvrecaudo a eliminar
     * @return El identificador del cnreCnvrecaudo que ha sido eliminado
     */
    public String eliminar(Integer cnreIderegistr) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", cnreIderegistr);
        manejadorCnreCnvrecaudo.deleteById(cnreIderegistr);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(cnreIderegistr));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorCnreCnvrecaudo.consultarTotalRegistros(filtros, 
                    rango));
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: cnreCnvrecaudoId$ASC, cnreCnvrecaudoName$DESC
     * @param atributo Nombre del atributo de la entidad CnreCnvrecaudo del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorCnreCnvrecaudo.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return CnreCnvrecaudo.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected CnreCnvrecaudoDTO instanciarDAO() {
        return new CnreCnvrecaudoDTO();
    }       

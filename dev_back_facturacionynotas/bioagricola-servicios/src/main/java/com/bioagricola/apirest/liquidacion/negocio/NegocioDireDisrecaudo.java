...
import com.bioagricola.apirest.modelo.entidades.DireDisrecaudo;
import com.bioagricola.apirest.modelo.excepciones.InvalidParameterException;
import com.bioagricola.apirest.modelo.manejadores.ManejadorDireDisrecaudo;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad DireDisrecaudo
 * @author GeneradorCRUD
 */
@Service
public class NegocioDireDisrecaudo extends NegocioAbstracto<DireDisrecaudo,DireDisrecaudoDTO> {

    @Autowired
    private ManejadorDireDisrecaudo manejadorDireDisrecaudo;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioDireDisrecaudo.class.getName());
     ...
     */
    public List<DireDisrecaudoDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorDireDisrecaudo.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de DireDisrecaudo recién creado
     */
    public DireDisrecaudoDTO crear(DireDisrecaudoDTO direDisrecaudoDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", direDisrecaudoDTO);

        DireDisrecaudo direDisrecaudo = new DireDisrecaudo();
        copiarPropiedades(direDisrecaudo, direDisrecaudoDTO);
        
        manejadorDireDisrecaudo.save(direDisrecaudo);

        return direDisrecaudoDTO;
     ...
     * @return La instancia de la entidad DireDisrecaudo que ha sido actualizado
     */
    public DireDisrecaudoDTO actualizar(DireDisrecaudoDTO direDisrecaudoDTO){
        ...
        logService(this.getClass().getName(), "actualizar", direDisrecaudoDTO);

        DireDisrecaudo direDisrecaudo = manejadorDireDisrecaudo.getOne(direDisrecaudoDTO.getDireIderegistr());                
        copiarPropiedades(direDisrecaudo, direDisrecaudoDTO);
    ...
    public String eliminar(Long direIderegistr) {
        ...
        logService(this.getClass().getName(), "eliminar", direIderegistr);
        manejadorDireDisrecaudo.deleteById(direIderegistr);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(direIderegistr));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorDireDisrecaudo.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorDireDisrecaudo.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return DireDisrecaudo.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected DireDisrecaudoDTO instanciarDAO() {
        return new DireDisrecaudoDTO();
    }       

...
import com.bioagricola.apirest.modelo.manejadores.ManejadorDicnDisconven;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad DicnDisconven
 * @author GeneradorCRUD
 */
@Service
public class NegocioDicnDisconven extends NegocioAbstracto<DicnDisconven,DicnDisconvenDTO> {

    @Autowired
    private ManejadorDicnDisconven manejadorDicnDisconven;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioDicnDisconven.class.getName());
     ...
     */
    public List<DicnDisconvenDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorDicnDisconven.consultar(filtros, ordenamiento, rango));
     ...
     * @return La insntancia de DicnDisconven recién creado
     */
    public DicnDisconvenDTO crear(DicnDisconvenDTO dicnDisconvenDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", dicnDisconvenDTO);

        DicnDisconven dicnDisconven = new DicnDisconven();
        copiarPropiedades(dicnDisconven, dicnDisconvenDTO);
        
        manejadorDicnDisconven.save(dicnDisconven);

        return dicnDisconvenDTO;
     ...
     * @return La instancia de la entidad DicnDisconven que ha sido actualizado
     */
    public DicnDisconvenDTO actualizar(DicnDisconvenDTO dicnDisconvenDTO){
        ...
        logService(this.getClass().getName(), "actualizar", dicnDisconvenDTO);

        DicnDisconven dicnDisconven = manejadorDicnDisconven.getOne(dicnDisconvenDTO.getDicnIderegistr());                
        copiarPropiedades(dicnDisconven, dicnDisconvenDTO);
    ...
    public String eliminar(Integer dicnIderegistr) {
        ...
        logService(this.getClass().getName(), "eliminar", dicnIderegistr);
        manejadorDicnDisconven.deleteById(dicnIderegistr);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(dicnIderegistr));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorDicnDisconven.consultarTotalRegistros(filtros, 
                    rango));
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorDicnDisconven.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return DicnDisconven.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected DicnDisconvenDTO instanciarDAO() {
        return new DicnDisconvenDTO();
    }       

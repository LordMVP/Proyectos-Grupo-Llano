...
import com.bioagricola.apirest.modelo.manejadores.ManejadorFunFuncion;
...
/**
 * Servicios para operaciones CRUD y de negocio sobre la entidad FunFuncion
 * @author GeneradorCRUD
 */
@Service
public class NegocioFunFuncion extends NegocioAbstracto<FunFuncion,FunFuncionDTO> {

    @Autowired
    private ManejadorFunFuncion manejadorFunFuncion;

    /**
     * Variable estatica para imprimir logs...
     */
    private static final Logger logger = Logger.getLogger(NegocioFunFuncion.class.getName());
    ...
    /**
     * Realiza un consulta en la entidad FunFuncion aplicando los filtros, el ordenamiento,
     ...
     * Ej. Una secuencia de parámetros de filtrado puede ser {@literal funFuncionId>1&funFuncionName:LIKE:juan}
     ...
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: funFuncionId$ASC, funFuncionName$DESC
     ...
     * @return Una lista de DAOs de los FunFuncion que se consultaron con los parámetros enviados por el cliente
     ...
     */
    public List<FunFuncionDTO> consultar(String filterBy, 
        ...
        return convertirListaEntidadesADao(manejadorFunFuncion.consultar(filtros, ordenamiento, rango));
        // protected region Modifique el metodo consultar end
    }

    /**
     * Crea el funFuncion que se pasa como parámetro en la base de datos.
     * 
     * @param funFuncionDTO El DAO de la entidad FunFuncion a crear. Este se envía en el cuerpo de la
     * solicitud POST como un objeto JSON.
     * @return La insntancia de FunFuncion recién creado
     */
    public FunFuncionDTO crear(FunFuncionDTO funFuncionDTO) {
    	// protected region Modifique el metodo crear on begin
    	
        logService(this.getClass().getName(), "crear", funFuncionDTO);

        FunFuncion funFuncion = new FunFuncion();
        copiarPropiedades(funFuncion, funFuncionDTO);
        
        manejadorFunFuncion.save(funFuncion);

        return funFuncionDTO;
        // protected region Modifique el metodo crear end
    }

    /**
     * Actualiza en la base de datos el funFuncion que se pasa como parámetro.
     * 
     * @param funFuncionDTO El DAO de la entidad FunFuncion a actualizar. Este se envía en el cuerpo de la
     * solicitud PUT como un objeto JSON.
     * @return La instancia de la entidad FunFuncion que ha sido actualizado
     */
    public FunFuncionDTO actualizar(FunFuncionDTO funFuncionDTO){
        // protected region Modifique el metodo actualizar on begin
    
        logService(this.getClass().getName(), "actualizar", funFuncionDTO);

        FunFuncion funFuncion = manejadorFunFuncion.getOne(funFuncionDTO.getFunNombre());                
        copiarPropiedades(funFuncion, funFuncionDTO);
    ...
    /**
     * Elimina el funFuncion con el identificador que se pasa como parámetro.
     * 
     * @param funNombre Valor del atributo del identificador de la instancia de la entidad  funFuncion a eliminar
     * @return El identificador del funFuncion que ha sido eliminado
     */
    public String eliminar(String funNombre) {
        // protected region Modifique el metodo eliminar on begin

        logService(this.getClass().getName(), "eliminar", funNombre);
        manejadorFunFuncion.deleteById(funNombre);
        
		
		StringBuilder valores = new StringBuilder();
		valores.append(String.valueOf(funNombre));
    ...
    public String contar(String filterBy,
        ...
        return String.valueOf(manejadorFunFuncion.consultarTotalRegistros(filtros, 
                    rango));
     ...
     * parámetro debe ir separado por coma : ','.
     * Ej. Una secuencia de parámetros de ordenamiento puede ser: funFuncionId$ASC, funFuncionName$DESC
     * @param atributo Nombre del atributo de la entidad FunFuncion del cual se quieren obtener los diferentes valores.
    ...
    public List<String> consultarLista(String filterBy,
        ...
        return UtilOperaciones.convertirListaObjetosAString(manejadorFunFuncion.consultarLista(filtros, ordenamiento, infoAgrupamiento));
    ...
    protected boolean entidadContieneAtributo(String nombreAtributo) {
        return FunFuncion.contieneAtributo(nombreAtributo);
    }
     ...
     */
    @Override
    protected FunFuncionDTO instanciarDAO() {
        return new FunFuncionDTO();
    }       

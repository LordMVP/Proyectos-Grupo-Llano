 ...
 * la tabla correspondiente a la entidad UniUnidad.
 * 
 * @author GeneradorCRUD
 */
@Service
public interface ManejadorUniUnidad extends ManejadorCrud<UniUnidad,Integer>,IManejadorCrud<UniUnidad,Integer>{

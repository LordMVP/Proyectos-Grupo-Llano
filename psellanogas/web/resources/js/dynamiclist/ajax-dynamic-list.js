...
//	var ajax_list_externalFile = 'ajax-list-countries.php';	// Path to external file
	...
	function ajax_showOptions(inputObj,paramToExternalFile,e)
	{
		...
		if(ajax_list_cachedLists[paramToExternalFile][inputObj.value.toLowerCase()]){
			...
			var letters = inputObj.value.toLowerCase().replace(" ","+");
			letters = letters.replace("á","a");
			letters = letters.replace("é","e");
			letters = letters.replace("í","i");
			letters = letters.replace("ó","o");
			letters = letters.replace("ú","u");

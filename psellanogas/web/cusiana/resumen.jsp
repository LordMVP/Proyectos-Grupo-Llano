...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta charset="UTF-8" />
        <title>Cusianagas - Pagos en línea</title>
            ...
            <div id="header">
                ...
                <div id="navbar">
                    <ul id="MainMenuBar">
                        ...
                        <li><a  href="/wspse/cusiana/">Realizar otro pago</a></li>
                    </ul>
                </div>
            </div>
            <div>
                        ...
                        <div id="client-details" class="col-md-8 offset-md-2
                            ...
                            <p>
                                ...
                                <c:forEach items="${listaDetalles}" var="detalle">
                                    ...
                                    <c:if test="${detalle.idEmpresa eq idEmpresaPrincipal}">
                                        ...
                                        <span><i class="fa fa-usd"></i> Cusiana S.A  E.S.P: <span class="invoice-date pull-right">${detalle.valorPago}</span> </span> <br />

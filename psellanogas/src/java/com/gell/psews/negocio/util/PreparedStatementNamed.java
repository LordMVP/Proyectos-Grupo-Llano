...
public class PreparedStatementNamed {
     ...
     */
    public PreparedStatementNamed(Connection connection, String query, boolean returnGeneratedKeys) throws SQLException {
    ...
    public PreparedStatementNamed(Connection connection, String query) throws SQLException {
     ...
     * CLIENT CODE. This method is non-private so JUnit code can testSelect it.
     *
    ...
    public void setArray(String facturas, String[] facturas0) {

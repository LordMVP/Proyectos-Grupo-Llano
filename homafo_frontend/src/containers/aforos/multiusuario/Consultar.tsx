...
import AforoMultiTable from '../../../components/Table/AforoMultiTable'
import { connect } from 'react-redux'
import { LoadAforos, clearAforosResult , LoadAforosMulti } from '../../../actions/aforos/generalActions'
...
class Consultar extends Component<{ aforos: any, actions: any, aforos_result: any, selects: any }> {
    state = {
        loading: false,
        databuscado:true,
        data: [],
    ...
    componentDidMount() {
        ...
        this.setState({ data: this.props.aforos_result.data || [] })
        //this.setState({ data: [] })
        //console.log('estoy en componentDidMount multiaofor /////////////',this.props.aforos_result.data);
    }
    ...
    onSubmit = async (data: any) => {
        ...
        this.props.actions.LoadAforosMulti(data, () => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <AforoMultiTable   data={this.state.data || []} urlLinkButton="/aforos/multiusuario/editar"  />:
...
const mapToDispatchToProps = dispatch => {
    ...
    return {
        actions: bindActionCreators({ LoadAforos, clearAforosResult, loadMunicipio, loadTipoUso, loadUbicacion, loadEstrato, loadCiclo, loadRuta, LoadAforosMulti }, dispatch)
    }
}

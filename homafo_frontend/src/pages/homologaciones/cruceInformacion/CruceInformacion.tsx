...
import TableCruceHomologacion from '../../../components/utils/TableCruceHomologacion/TableCruceHomologacion';
...
class CruceInformacion extends React.Component<IProps, any>
{
    constructor(props: IProps) {
        ...
        this.state={
            ...
            //vistaLista:false,
            //vistaEditar:false,
            encabezadoLista:['Codigo','Identificacion','Nombres','Direccion','Convenio'],
            listaResultado:[],
            menuEditar:['+','+','+','+'],
            estadoBusqueda: 0,
            basico:{primero:'nada'},
    ...
    async componentDidMount()
    {
        ...
        await sesionApi.loadPermisos(PARAMETROS.CRUCE_INFORMACION.PROGRAMA_ID).then(response => {
    ...
    {
      let effectivePermission = UtilsFunction.getEffectivePermissions(this.state.permissions,'CRUCE_INFORMACION');    
    ...
    buscar = async (e: any) => {
        ...
        let api: homoApi = new homoApi();
        let tmp:any = await trackPromise(api.listaBusquedaGeneralCruceInformacion(e));
        //console.log(e);
        await this.setState({
            ...
            return(
                <div>
                    <Row>
                        <Col>
                            <div className="form-group">
                                <BusquedaComponent nombreBoton='Consultar Cruce Datos' buscarMetodo={this.buscar} limpiarMetodo={this.limpiar} key={this.state.estadoBusqueda} listar={this.listar}/>
                            </div>                                
                        </Col>                        
                    </Row>                        
                </div>
                        ...
                        <Col>
                            <Card className="mb-5">
                                ...
                                <Suspense fallback={<h1>Cargando Informacion ...</h1>}>
                                    <TableCruceHomologacion datosLogin={this.state.login} datosParametros={this.state.parametros} valorkey="Codigo" encabezado={this.state.encabezadoLista} datos={this.state.listaResultado} editar={this.editarHomo}></TableCruceHomologacion>
                                </Suspense>    
                                </Card.Body>
                            </Card>
                        </Col>
                ...
                <Suspense fallback={<div>Cargando...</div>}>
                    <div className="row">
                        <div className="d-flex p-2 bd-highlight">
                            <h2>Cruce Informacion Homologacion</h2>
                        </div>
...
export default CruceInformacion;
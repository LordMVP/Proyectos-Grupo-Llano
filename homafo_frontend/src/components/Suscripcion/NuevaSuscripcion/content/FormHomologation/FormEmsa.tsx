...
function FormEmsa(props: Props) {
  ...
  const handleDataEdit = (data: any) => {
    ...
    handloToggle();
    handleChangeConvenio(`${data?.cnreNombre}`);
  };
  ...
  return (
    <>
      ...
      >
        ...
        <Form.Group as={Col} md="6">
          <Form.Label>Consumo Energía</Form.Label>
          <Form.Row>
            {currentData &&
...
export default connect(mapStateToProps, mapDispatchToProps)(FormEmsa);

...
class ItemDataDialog(
    ...
    fun showPopup(anchorView: View) {
        ...
        val popupView = inflater.inflate(R.layout.dialog_item_data, null)
        ...
        // Listeners
        popupView.findViewById<TextView>(R.id.item_delete).setOnClickListener {
            deleteItem()
            popupWindow.dismiss()
        }

        popupView.findViewById<TextView>(R.id.item_edit).setOnClickListener {
            editItem()
            popupWindow.dismiss()
        }
    }

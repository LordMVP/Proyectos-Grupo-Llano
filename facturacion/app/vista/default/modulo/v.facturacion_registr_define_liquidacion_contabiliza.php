<form name="facturacion_registr_define_liquidacion_contabiliza" id="facturacion_registr_define_liquidacion_contabiliza" method="POST">
<div class="botonera">
...
<h2>Contabilizaci&oacute;n Conceptos </h2>
<div class="campo">
...
<div  class="espacioAdicion">	
		<div class="campo">
		    <br><br>
		    <label for="ndebcre">Debito/Credito</label>
		    <select name="ndebcre" id="ndebcre"><script type="text/javascript">new Combo('debcre','ndebcre');</script></select>
